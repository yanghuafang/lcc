...
///
/// This is the one stage that is not lcc's own logic — LLVM's TargetMachine
/// does instruction selection, register allocation, and encoding. What lives
/// here is the setup: resolve the triple to a registered target, build a
/// TargetMachine from the CPU and feature string, and run LLVM's codegen
