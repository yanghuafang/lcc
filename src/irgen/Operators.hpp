...
/// through ptrtoint since opaque pointers carry no width of their own. Null
/// when the operand pair is none of those, which is the caller's cue to report
/// the operator it was lowering.
///
...
/// createCompare fixed at equality, throwing rather than returning null. Used
/// by
