...
// the functions here *emit* the instructions that get the values there. Keeping
// the decision LLVM-free is what lets types/ stay a leaf, so these live in
// irgen/ instead — they need an IRBuilder, and anything holding an IRBuilder
