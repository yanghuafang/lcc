...
void CodeGenerator::genIrCode(AST::Program* root,
                              ...
                              const std::string& irStatsPath, bool foldAddZero,
  ...
  // and debug finalization (-g). main's -l dumps later (post-genObjectCode)
  // with target triple/data layout for compile-tests.sh golden files.
...
void CodeGenerator::setTargetBackendOptions(
