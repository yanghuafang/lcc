...
// LLVM DIBuilder wrapper for lcc -g. Embeds DWARF in the .o via module
// metadata; finalize() must run after IR emission and before genObjectCode().
class DebugInfoBuilder {
 public:
  ...
  // Struct/union DI needs AST field lists and getType(); set before
  // declareAlloca.
