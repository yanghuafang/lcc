...
/// element type from the AST instead of from the llvm::Value. Nothing here
/// emits instructions; the C type arithmetic these answers feed into lives in
...
/// The struct or union a VarType denotes, through typedef aliases and struct
/// tag names — a DefinedType such as "Employee" after "typedef struct Employee
