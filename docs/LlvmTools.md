...
Until M18 lands, use the **Tools reference** and milestone study steps in [LearningPlan.md](LearningPlan.md) (M2, M9, M13, M14). Implementation details for middle/back-end work: [MiddleBackendNotes.md](MiddleBackendNotes.md).
