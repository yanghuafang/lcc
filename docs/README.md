...
| [FrontendNotes.md](FrontendNotes.md) | Extension plan, dependencies, and acceptance criteria |
| [ParserConflicts.md](ParserConflicts.md) | Parser shift/reduce and reduce/reduce conflicts (Bison) |

Start with the [README](../README.md) for a quick clone-and-run path, then dive into the guides above as needed.
