...
entry:
  %failed = alloca i32, align 4
    #dbg_declare(ptr %failed, !75, !DIExpression(), !76)
  store i32 0, ptr %failed, align 4, !dbg !76
  %0 = call i32 @countTo(i32 5), !dbg !77
  %1 = icmp ne i32 %0, 5, !dbg !77
  br i1 %1, label %then, label %else, !dbg !77

then:                                             ; preds = %entry
  store i32 1, ptr %failed, align 4, !dbg !78
  %2 = load i32, ptr %failed, align 4, !dbg !78
...
if.end:                                           ; preds = %else, %then
  %3 = call i32 @skip(i32 1), !dbg !80
  %4 = icmp ne i32 %3, 1, !dbg !80
  br i1 %4, label %lor.end, label %lor.rhs, !dbg !80

lor.rhs:                                          ; preds = %if.end
  %5 = call i32 @skip(i32 0), !dbg !80
  %6 = icmp ne i32 %5, 2, !dbg !80
  br label %lor.end, !dbg !80

lor.end:                                          ; preds = %lor.rhs, %if.end
  %7 = phi i1 [ true, %if.end ], [ %6, %lor.rhs ], !dbg !80
  br i1 %7, label %then1, label %else2, !dbg !80

then1:                                            ; preds = %lor.end
  store i32 1, ptr %failed, align 4, !dbg !81
  %8 = load i32, ptr %failed, align 4, !dbg !81
...
if.end3:                                          ; preds = %else2, %then1
  %9 = call i32 @firstPair(i32 5, i32 23), !dbg !83
  %10 = icmp ne i32 %9, 23, !dbg !83
  br i1 %10, label %lor.end5, label %lor.rhs4, !dbg !83

lor.rhs4:                                         ; preds = %if.end3
  %11 = call i32 @firstPair(i32 3, i32 99), !dbg !83
  %12 = icmp ne i32 %11, -1, !dbg !83
  br label %lor.end5, !dbg !83

lor.end5:                                         ; preds = %lor.rhs4, %if.end3
  %13 = phi i1 [ true, %if.end3 ], [ %12, %lor.rhs4 ], !dbg !83
  br i1 %13, label %then6, label %else7, !dbg !83

then6:                                            ; preds = %lor.end5
  store i32 1, ptr %failed, align 4, !dbg !84
  %14 = load i32, ptr %failed, align 4, !dbg !84
...
if.end8:                                          ; preds = %else7, %then6
  %15 = call i32 @afterReturn(i32 1), !dbg !86
  %16 = icmp ne i32 %15, 2, !dbg !86
  br i1 %16, label %lor.end10, label %lor.rhs9, !dbg !86

lor.rhs9:                                         ; preds = %if.end8
  %17 = call i32 @afterReturn(i32 0), !dbg !86
  %18 = icmp ne i32 %17, 1, !dbg !86
  br label %lor.end10, !dbg !86

lor.end10:                                        ; preds = %lor.rhs9, %if.end8
  %19 = phi i1 [ true, %if.end8 ], [ %18, %lor.rhs9 ], !dbg !86
  br i1 %19, label %then11, label %else12, !dbg !86

then11:                                           ; preds = %lor.end10
  store i32 1, ptr %failed, align 4, !dbg !87
  %20 = load i32, ptr %failed, align 4, !dbg !87
...
if.end13:                                         ; preds = %else12, %then11
  %21 = call i32 @fromSwitch(i32 1), !dbg !89
  %22 = icmp ne i32 %21, 10, !dbg !89
  br i1 %22, label %lor.end15, label %lor.rhs14, !dbg !89

lor.rhs14:                                        ; preds = %if.end13
  %23 = call i32 @fromSwitch(i32 2), !dbg !89
  %24 = icmp ne i32 %23, 20, !dbg !89
  br label %lor.end15, !dbg !89

lor.end15:                                        ; preds = %lor.rhs14, %if.end13
  %25 = phi i1 [ true, %if.end13 ], [ %24, %lor.rhs14 ], !dbg !89
  br i1 %25, label %lor.end17, label %lor.rhs16, !dbg !89

lor.rhs16:                                        ; preds = %lor.end15
  %26 = call i32 @fromSwitch(i32 9), !dbg !89
  %27 = icmp ne i32 %26, 0, !dbg !89
  br label %lor.end17, !dbg !89

lor.end17:                                        ; preds = %lor.rhs16, %lor.end15
  %28 = phi i1 [ true, %lor.end15 ], [ %27, %lor.rhs16 ], !dbg !89
  br i1 %28, label %then18, label %else19, !dbg !89

then18:                                           ; preds = %lor.end17
  store i32 1, ptr %failed, align 4, !dbg !90
  %29 = load i32, ptr %failed, align 4, !dbg !90
  br label %if.end20, !dbg !90

else19:                                           ; preds = %lor.end17
  br label %if.end20, !dbg !90

if.end20:                                         ; preds = %else19, %then18
  %30 = load i32, ptr %failed, align 4, !dbg !92
  %31 = icmp eq i32 %30, 0, !dbg !92
  br i1 %31, label %then21, label %else22, !dbg !92

then21:                                           ; preds = %if.end20
  %32 = call i32 (ptr, ...) @printf(ptr @0), !dbg !93
  ret i32 0, !dbg !95
...
if.end23:                                         ; preds = %else22
  %33 = call i32 (ptr, ...) @printf(ptr @1), !dbg !96
  ret i32 1, !dbg !97
}
...
!62 = !DILocation(line: 66, column: 3, scope: !55)
!63 = distinct !DISubprogram(name: "fromSwitch", linkageName: "fromSwitch", scope: null, file: !3, line: 70, type: !5, scopeLine: 70, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !8)
...
!71 = !DILocation(line: 81, column: 3, scope: !63)
!72 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 84, type: !73, scopeLine: 84, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !8)
!73 = !DISubroutineType(types: !74)
!74 = !{!7}
!75 = !DILocalVariable(name: "failed", scope: !72, file: !3, line: 85, type: !7)
!76 = !DILocation(line: 85, column: 3, scope: !72)
!77 = !DILocation(line: 87, column: 3, scope: !72)
!78 = !DILocation(line: 88, column: 5, scope: !79)
!79 = distinct !DILexicalBlock(scope: !72, file: !3, line: 87, column: 24)
!80 = !DILocation(line: 90, column: 3, scope: !72)
!81 = !DILocation(line: 91, column: 5, scope: !82)
!82 = distinct !DILexicalBlock(scope: !72, file: !3, line: 90, column: 37)
!83 = !DILocation(line: 93, column: 3, scope: !72)
!84 = !DILocation(line: 94, column: 5, scope: !85)
!85 = distinct !DILexicalBlock(scope: !72, file: !3, line: 93, column: 57)
!86 = !DILocation(line: 96, column: 3, scope: !72)
!87 = !DILocation(line: 97, column: 5, scope: !88)
!88 = distinct !DILexicalBlock(scope: !72, file: !3, line: 96, column: 51)
!89 = !DILocation(line: 99, column: 3, scope: !72)
!90 = !DILocation(line: 100, column: 5, scope: !91)
!91 = distinct !DILexicalBlock(scope: !72, file: !3, line: 99, column: 73)
!92 = !DILocation(line: 103, column: 3, scope: !72)
!93 = !DILocation(line: 104, column: 5, scope: !94)
!94 = distinct !DILexicalBlock(scope: !72, file: !3, line: 103, column: 20)
!95 = !DILocation(line: 105, column: 5, scope: !94)
!96 = !DILocation(line: 107, column: 3, scope: !72)
!97 = !DILocation(line: 108, column: 3, scope: !72)
