...
entry:
  ...
  %0 = bitcast ptr %la to ptr, !dbg !21
  ...
  %3 = bitcast ptr %ls to ptr, !dbg !16
  ...
  %9 = bitcast ptr %lb to ptr, !dbg !14
  ...
  %15 = bitcast ptr %la to ptr, !dbg !24
  %16 = load i32, ptr %15, align 4, !dbg !24
  %17 = icmp ne i32 %16, 1, !dbg !24
  br i1 %17, label %then, label %if.end, !dbg !24
...
if.end:                                           ; preds = %entry, %then
  ...
  br i1 %21, label %then1, label %if.end3, !dbg !26
...
if.end3:                                          ; preds = %if.end, %then1
  ...
  br i1 %25, label %then4, label %if.end6, !dbg !28
...
if.end9:                                          ; preds = %if.end6, %then7
  ...
  br i1 %35, label %then10, label %if.end12, !dbg !32
...
if.end12:                                         ; preds = %if.end9, %then10
  ...
  br i1 %40, label %then13, label %if.end15, !dbg !34
...
if.end15:                                         ; preds = %if.end12, %then13
  ...
  br i1 %45, label %then16, label %if.end18, !dbg !36
...
if.end18:                                         ; preds = %if.end15, %then16
  ...
  br i1 %50, label %then19, label %if.end21, !dbg !38
...
if.end21:                                         ; preds = %if.end18, %then19
  ...
  br i1 %55, label %then22, label %if.end24, !dbg !40
...
if.end27:                                         ; preds = %if.end24, %then25
  ...
  br i1 %65, label %then28, label %if.end30, !dbg !44
...
if.end30:                                         ; preds = %if.end27, %then28
  ...
  br i1 %68, label %then31, label %if.end33, !dbg !46
...
if.end33:                                         ; preds = %if.end30, %then31
  ...
  br i1 %71, label %then34, label %if.end36, !dbg !48
...
if.end36:                                         ; preds = %if.end33, %then34
  ...
  br i1 %74, label %then37, label %if.end39, !dbg !50
...
if.end39:                                         ; preds = %if.end36, %then37
  ...
  br i1 %77, label %then40, label %if.end42, !dbg !52
...
if.end42:                                         ; preds = %if.end39, %then40
  ...
  br i1 %80, label %then43, label %if.end45, !dbg !54
...
if.end45:                                         ; preds = %if.end42, %then43
  ...
  br i1 %83, label %then46, label %if.end48, !dbg !56
...
if.end48:                                         ; preds = %if.end45, %then46
  ...
  br i1 %87, label %then49, label %if.end51, !dbg !58
...
if.end51:                                         ; preds = %if.end48, %then49
  ...
  br i1 %91, label %then52, label %if.end54, !dbg !60
...
if.end54:                                         ; preds = %if.end51, %then52
  ...
  br i1 %95, label %then55, label %if.end57, !dbg !62
...
if.end57:                                         ; preds = %if.end54, %then55
  ...
  br i1 %99, label %then58, label %if.end60, !dbg !64
...
if.end60:                                         ; preds = %if.end57, %then58
  ...
  br i1 %103, label %then61, label %if.end63, !dbg !66
...
if.end63:                                         ; preds = %if.end60, %then61
  ...
  br i1 %107, label %then64, label %if.end66, !dbg !68
...
if.end66:                                         ; preds = %if.end63, %then64
  ...
  br i1 %111, label %then67, label %if.end69, !dbg !70
...
if.end69:                                         ; preds = %if.end66, %then67
  ...
  %. = select i1 %114, ptr @0, ptr @1, !dbg !73
  %115 = call i32 (ptr, ...) @printf(ptr %.), !dbg !73
