...
entry:
  ...
  %0 = bitcast ptr %la to ptr, !dbg !23
  ...
  %4 = bitcast ptr %lb to ptr, !dbg !18
...
if.end:                                           ; preds = %entry, %then
  ...
  br i1 %15, label %then1, label %if.end3, !dbg !28
...
if.end3:                                          ; preds = %if.end, %then1
  ...
  br i1 %19, label %then4, label %if.end6, !dbg !30
...
if.end6:                                          ; preds = %if.end3, %then4
  ...
  br i1 %23, label %then7, label %if.end9, !dbg !32
...
if.end9:                                          ; preds = %if.end6, %then7
  %25 = bitcast ptr %lb to ptr, !dbg !34
  %26 = load i32, ptr %25, align 4, !dbg !34
  %27 = icmp ne i32 %26, 4, !dbg !34
  br i1 %27, label %then10, label %if.end12, !dbg !34
...
if.end12:                                         ; preds = %if.end9, %then10
  ...
  br i1 %31, label %then13, label %if.end15, !dbg !36
...
if.end15:                                         ; preds = %if.end12, %then13
  ...
  br i1 %35, label %then16, label %if.end18, !dbg !38
...
if.end18:                                         ; preds = %if.end15, %then16
  %37 = bitcast ptr %lc to ptr, !dbg !40
  %38 = load i32, ptr %37, align 4, !dbg !40
  %39 = icmp ne i32 %38, 0, !dbg !40
  br i1 %39, label %then19, label %if.end21, !dbg !40
...
if.end21:                                         ; preds = %if.end18, %then19
  ...
  br i1 %43, label %then22, label %if.end24, !dbg !42
...
if.end24:                                         ; preds = %if.end21, %then22
  ...
  br i1 %46, label %then25, label %if.end27, !dbg !44
...
if.end27:                                         ; preds = %if.end24, %then25
  ...
  br i1 %49, label %then28, label %if.end30, !dbg !46
...
if.end30:                                         ; preds = %if.end27, %then28
  ...
  br i1 %52, label %then31, label %if.end33, !dbg !48
...
if.end33:                                         ; preds = %if.end30, %then31
  ...
  br i1 %55, label %then34, label %if.end36, !dbg !50
...
if.end36:                                         ; preds = %if.end33, %then34
  ...
  br i1 %58, label %then37, label %if.end39, !dbg !52
...
if.end39:                                         ; preds = %if.end36, %then37
  ...
  br i1 %61, label %then40, label %if.end42, !dbg !54
...
if.end42:                                         ; preds = %if.end39, %then40
  ...
  %. = select i1 %64, ptr @0, ptr @1, !dbg !57
  %65 = call i32 (ptr, ...) @printf(ptr %.), !dbg !57
  %66 = load i32, ptr %err, align 4, !dbg !58
  ret i32 %66, !dbg !58
}
