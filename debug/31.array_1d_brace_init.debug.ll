...
if.end42:                                         ; preds = %if.end39, %then40
  %72 = load i32, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @gc, i32 0, i32 0), align 4, !dbg !54
  %73 = icmp ne i32 %72, 0, !dbg !54
  br i1 %73, label %then43, label %if.end45, !dbg !54
...
if.end45:                                         ; preds = %if.end42, %then43
  %75 = load i32, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @gc, i32 0, i32 1), align 4, !dbg !56
  %76 = icmp ne i32 %75, 0, !dbg !56
  br i1 %76, label %then46, label %if.end48, !dbg !56

then46:                                           ; preds = %if.end45
  store i32 1, i32* %err, align 4, !dbg !57
  %77 = load i32, i32* %err, align 4, !dbg !57
  br label %if.end48, !dbg !57

if.end48:                                         ; preds = %if.end45, %then46
  %78 = load i32, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @gc, i32 0, i32 2), align 4, !dbg !58
  %79 = icmp ne i32 %78, 0, !dbg !58
  br i1 %79, label %then49, label %if.end51, !dbg !58

then49:                                           ; preds = %if.end48
  store i32 1, i32* %err, align 4, !dbg !59
  %80 = load i32, i32* %err, align 4, !dbg !59
  br label %if.end51, !dbg !59

if.end51:                                         ; preds = %if.end48, %then49
  %81 = load i32, i32* %err, align 4, !dbg !60
  %82 = icmp eq i32 %81, 0, !dbg !60
  %. = select i1 %82, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @1, i32 0, i32 0), !dbg !61
  %83 = call i32 (i8*, ...) @printf(i8* %.), !dbg !61
  %84 = load i32, i32* %err, align 4, !dbg !62
  ret i32 %84, !dbg !62
}
