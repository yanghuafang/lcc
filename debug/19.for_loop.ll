...
@3 = private unnamed_addr constant [25 x i8] c"**** 19.for_loop.c ****\0A\00", align 1
...
@6 = private unnamed_addr constant [18 x i8] c"1+2+...+100 = %d\0A\00", align 1
@7 = private unnamed_addr constant [14 x i8] c"countSum(100)\00", align 1
@8 = private unnamed_addr constant [15 x i8] c"countSum2(100)\00", align 1
@9 = private unnamed_addr constant [15 x i8] c"countSum3(100)\00", align 1
@10 = private unnamed_addr constant [21 x i8] c"countSum(0) boundary\00", align 1
@11 = private unnamed_addr constant [21 x i8] c"countSum(1) boundary\00", align 1
...
entry:
  ...
  %8 = call i32 @countSum3(i32 100)
  store i32 %8, i32* %sum100, align 4
  %9 = load i32, i32* %sum100, align 4
  %10 = load i32, i32* %sum100, align 4
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @6, i32 0, i32 0), i32 %10)
  %12 = call i32 @countSum(i32 100)
  call void @check_int(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @7, i32 0, i32 0), i32 %12, i32 5050)
  %13 = call i32 @countSum2(i32 100)
  call void @check_int(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @8, i32 0, i32 0), i32 %13, i32 5050)
  %14 = call i32 @countSum3(i32 100)
  call void @check_int(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @9, i32 0, i32 0), i32 %14, i32 5050)
  %15 = call i32 @countSum(i32 0)
  call void @check_int(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @10, i32 0, i32 0), i32 %15, i32 0)
  %16 = call i32 @countSum(i32 1)
  call void @check_int(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @11, i32 0, i32 0), i32 %16, i32 1)
