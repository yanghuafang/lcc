...
if.end15:                                         ; preds = %else14, %then13
  ...
  br i1 %19, label %then16, label %else17, !dbg !33
...
if.end18:                                         ; preds = %else17, %then16
  ...
  br i1 %22, label %then19, label %else20, !dbg !35

then19:                                           ; preds = %if.end18
  %23 = call i32 (ptr, ...) @printf(ptr @0), !dbg !36
  br label %if.end21, !dbg !36

else20:                                           ; preds = %if.end18
  %24 = call i32 (ptr, ...) @printf(ptr @1), !dbg !38
...
!2 = distinct !DISubprogram(name: "get_seed", linkageName: "get_seed", scope: null, file: !1, line: 7, type: !3, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !0)
!3 = !DISubroutineType(types: !4)
!4 = !{!5}
!5 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!6 = !DILocation(line: 7, column: 22, scope: !2)
!7 = distinct !DISubprogram(name: "counter_calls", linkageName: "counter_calls", scope: null, file: !1, line: 9, type: !3, scopeLine: 9, spFlags: DISPFlagDefinition, unit: !0)
!8 = !DILocation(line: 11, column: 3, scope: !7)
!9 = !DILocation(line: 12, column: 3, scope: !7)
!10 = distinct !DISubprogram(name: "counter_with_init", linkageName: "counter_with_init", scope: null, file: !1, line: 15, type: !3, scopeLine: 15, spFlags: DISPFlagDefinition, unit: !0)
!11 = !DILocation(line: 17, column: 3, scope: !10)
!12 = !DILocation(line: 18, column: 3, scope: !10)
!13 = distinct !DISubprogram(name: "bump_runtime_static_decl", linkageName: "bump_runtime_static_decl", scope: null, file: !1, line: 21, type: !3, scopeLine: 21, spFlags: DISPFlagDefinition, unit: !0)
!14 = !DILocation(line: 22, column: 10, scope: !13)
!15 = !DILocation(line: 23, column: 3, scope: !13)
!16 = !DILocation(line: 24, column: 3, scope: !13)
!17 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !1, line: 27, type: !3, scopeLine: 27, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !18)
!18 = !{}
!19 = !DILocalVariable(name: "err", scope: !17, file: !1, line: 28, type: !5)
!20 = !DILocation(line: 28, column: 3, scope: !17)
!21 = !DILocation(line: 30, column: 3, scope: !17)
!22 = !DILocation(line: 30, column: 29, scope: !17)
!23 = !DILocation(line: 31, column: 3, scope: !17)
!24 = !DILocation(line: 31, column: 29, scope: !17)
!25 = !DILocation(line: 32, column: 3, scope: !17)
!26 = !DILocation(line: 32, column: 29, scope: !17)
!27 = !DILocation(line: 34, column: 3, scope: !17)
!28 = !DILocation(line: 34, column: 34, scope: !17)
!29 = !DILocation(line: 35, column: 3, scope: !17)
!30 = !DILocation(line: 35, column: 34, scope: !17)
!31 = !DILocation(line: 37, column: 3, scope: !17)
!32 = !DILocation(line: 37, column: 40, scope: !17)
!33 = !DILocation(line: 38, column: 3, scope: !17)
!34 = !DILocation(line: 38, column: 40, scope: !17)
!35 = !DILocation(line: 40, column: 3, scope: !17)
!36 = !DILocation(line: 41, column: 5, scope: !37)
!37 = distinct !DILexicalBlock(scope: !17, file: !1, line: 40, column: 17)
!38 = !DILocation(line: 43, column: 5, scope: !39)
!39 = distinct !DILexicalBlock(scope: !17, file: !1, line: 42, column: 10)
!40 = !DILocation(line: 45, column: 3, scope: !17)
