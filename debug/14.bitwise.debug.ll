...
entry:
  ...
  store i32 %const37, ptr %b, align 4, !dbg !35
...
then31:                                           ; preds = %if.end30
  ...
  %75 = load i32, ptr %err, align 4, !dbg !69
  br label %if.end33, !dbg !69

if.end33:                                         ; preds = %if.end30, %then31
  %76 = load i32, ptr %err, align 4, !dbg !70
  %77 = icmp eq i32 %76, 0, !dbg !70
  %. = select i1 %77, ptr @0, ptr @1, !dbg !47
  %78 = call i32 (ptr, ...) @printf(ptr %.), !dbg !47
  %79 = load i32, ptr %err, align 4, !dbg !71
  ret i32 %79, !dbg !71
}
