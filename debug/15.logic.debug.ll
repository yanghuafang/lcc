...
if.end87:                                         ; preds = %else86, %then85
  ...
  br i1 %231, label %then88, label %else89, !dbg !121

then88:                                           ; preds = %if.end87
  %232 = call i32 (ptr, ...) @printf(ptr @0), !dbg !122
  br label %if.end90, !dbg !122

else89:                                           ; preds = %if.end87
  %233 = call i32 (ptr, ...) @printf(ptr @1), !dbg !124
  br label %if.end90, !dbg !124

if.end90:                                         ; preds = %else89, %then88
  %234 = load i32, ptr %err, align 4, !dbg !126
  ret i32 %234, !dbg !126
}
...
!8 = !{}
!9 = !DILocalVariable(name: "ui", scope: !4, file: !1, line: 79, type: !10)
!10 = !DIBasicType(name: "unsigned int", size: 32, encoding: DW_ATE_unsigned)
!11 = !DILocation(line: 79, column: 3, scope: !4)
!12 = !DILocalVariable(name: "si", scope: !4, file: !1, line: 78, type: !7)
!13 = !DILocation(line: 78, column: 3, scope: !4)
!14 = !DILocalVariable(name: "ub", scope: !4, file: !1, line: 72, type: !10)
!15 = !DILocation(line: 72, column: 3, scope: !4)
!16 = !DILocalVariable(name: "ua", scope: !4, file: !1, line: 71, type: !10)
!17 = !DILocation(line: 71, column: 3, scope: !4)
!18 = !DILocalVariable(name: "c", scope: !4, file: !1, line: 36, type: !7)
!19 = !DILocation(line: 36, column: 3, scope: !4)
!20 = !DILocalVariable(name: "b", scope: !4, file: !1, line: 35, type: !7)
!21 = !DILocation(line: 35, column: 3, scope: !4)
!22 = !DILocalVariable(name: "a", scope: !4, file: !1, line: 34, type: !7)
!23 = !DILocation(line: 34, column: 3, scope: !4)
!24 = !DILocalVariable(name: "v", scope: !4, file: !1, line: 10, type: !7)
!25 = !DILocation(line: 10, column: 3, scope: !4)
!26 = !DILocalVariable(name: "f", scope: !4, file: !1, line: 9, type: !27)
!27 = !DIBasicType(name: "bool", size: 8, encoding: DW_ATE_boolean)
!28 = !DILocation(line: 9, column: 3, scope: !4)
!29 = !DILocalVariable(name: "t", scope: !4, file: !1, line: 8, type: !27)
!30 = !DILocation(line: 8, column: 3, scope: !4)
!31 = !DILocalVariable(name: "err", scope: !4, file: !1, line: 7, type: !7)
...
!121 = !DILocation(line: 85, column: 3, scope: !4)
!122 = !DILocation(line: 86, column: 5, scope: !123)
!123 = distinct !DILexicalBlock(scope: !4, file: !1, line: 85, column: 17)
!124 = !DILocation(line: 88, column: 5, scope: !125)
!125 = distinct !DILexicalBlock(scope: !4, file: !1, line: 87, column: 10)
!126 = !DILocation(line: 90, column: 3, scope: !4)
