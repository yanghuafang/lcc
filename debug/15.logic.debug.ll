...
if.end87:                                         ; preds = %else86, %then85
  ...
  %233 = sext i1 %232 to i32, !dbg !121
  store i32 %233, ptr %v, align 4, !dbg !121
  %234 = load i32, ptr %v, align 4, !dbg !121
  %235 = load i32, ptr %a, align 4, !dbg !122
  %236 = load i32, ptr %b, align 4, !dbg !122
  %237 = icmp eq i32 %235, %236, !dbg !122
  %238 = sext i1 %237 to i32, !dbg !122
  store i32 %238, ptr %v, align 4, !dbg !122
  %239 = load i32, ptr %v, align 4, !dbg !122
  %240 = load i1, ptr %t, align 1, !dbg !123
  %241 = load i1, ptr %t, align 1, !dbg !123
  %242 = select i1 %240, i1 %241, i1 false, !dbg !123
  %243 = sext i1 %242 to i32, !dbg !123
  store i32 %243, ptr %v, align 4, !dbg !123
  %244 = load i32, ptr %v, align 4, !dbg !123
  %245 = load i1, ptr %t, align 1, !dbg !124
  %246 = load i1, ptr %f, align 1, !dbg !124
  %247 = select i1 %245, i1 true, i1 %246, !dbg !124
  %248 = sext i1 %247 to i32, !dbg !124
  store i32 %248, ptr %v, align 4, !dbg !124
  %249 = load i32, ptr %v, align 4, !dbg !124
  %250 = load i1, ptr %f, align 1, !dbg !125
  %251 = icmp eq i1 %250, false, !dbg !125
  %252 = sext i1 %251 to i32, !dbg !125
  store i32 %252, ptr %v, align 4, !dbg !125
  %253 = load i32, ptr %v, align 4, !dbg !125
  %254 = load i32, ptr %err, align 4, !dbg !126
  %255 = icmp eq i32 %254, 0, !dbg !126
  br i1 %255, label %then88, label %else89, !dbg !126

then88:                                           ; preds = %if.end87
  %256 = call i32 (ptr, ...) @printf(ptr @0), !dbg !127
  br label %if.end90, !dbg !127

else89:                                           ; preds = %if.end87
  %257 = call i32 (ptr, ...) @printf(ptr @1), !dbg !129
  br label %if.end90, !dbg !129

if.end90:                                         ; preds = %else89, %then88
  %258 = load i32, ptr %err, align 4, !dbg !131
  ret i32 %258, !dbg !131
}
...
!8 = !{}
!9 = !DILocalVariable(name: "ui", scope: !4, file: !1, line: 80, type: !10)
!10 = !DIBasicType(name: "unsigned int", size: 32, encoding: DW_ATE_unsigned)
!11 = !DILocation(line: 80, column: 3, scope: !4)
!12 = !DILocalVariable(name: "si", scope: !4, file: !1, line: 79, type: !7)
!13 = !DILocation(line: 79, column: 3, scope: !4)
!14 = !DILocalVariable(name: "ub", scope: !4, file: !1, line: 73, type: !10)
!15 = !DILocation(line: 73, column: 3, scope: !4)
!16 = !DILocalVariable(name: "ua", scope: !4, file: !1, line: 72, type: !10)
!17 = !DILocation(line: 72, column: 3, scope: !4)
!18 = !DILocalVariable(name: "c", scope: !4, file: !1, line: 37, type: !7)
!19 = !DILocation(line: 37, column: 3, scope: !4)
!20 = !DILocalVariable(name: "b", scope: !4, file: !1, line: 36, type: !7)
!21 = !DILocation(line: 36, column: 3, scope: !4)
!22 = !DILocalVariable(name: "a", scope: !4, file: !1, line: 35, type: !7)
!23 = !DILocation(line: 35, column: 3, scope: !4)
!24 = !DILocalVariable(name: "v", scope: !4, file: !1, line: 11, type: !7)
!25 = !DILocation(line: 11, column: 3, scope: !4)
!26 = !DILocalVariable(name: "f", scope: !4, file: !1, line: 10, type: !27)
!27 = !DIBasicType(name: "bool", size: 8, encoding: DW_ATE_boolean)
!28 = !DILocation(line: 10, column: 3, scope: !4)
!29 = !DILocalVariable(name: "t", scope: !4, file: !1, line: 9, type: !27)
!30 = !DILocation(line: 9, column: 3, scope: !4)
!31 = !DILocalVariable(name: "err", scope: !4, file: !1, line: 8, type: !7)
!32 = !DILocation(line: 8, column: 3, scope: !4)
!33 = !DILocation(line: 13, column: 3, scope: !4)
!34 = !DILocation(line: 13, column: 15, scope: !4)
!35 = !DILocation(line: 14, column: 3, scope: !4)
!36 = !DILocation(line: 14, column: 15, scope: !4)
!37 = !DILocation(line: 16, column: 3, scope: !4)
!38 = !DILocation(line: 17, column: 3, scope: !4)
!39 = !DILocation(line: 17, column: 15, scope: !4)
!40 = !DILocation(line: 18, column: 3, scope: !4)
!41 = !DILocation(line: 19, column: 3, scope: !4)
!42 = !DILocation(line: 19, column: 15, scope: !4)
!43 = !DILocation(line: 20, column: 3, scope: !4)
!44 = !DILocation(line: 21, column: 3, scope: !4)
!45 = !DILocation(line: 21, column: 15, scope: !4)
!46 = !DILocation(line: 23, column: 3, scope: !4)
!47 = !DILocation(line: 24, column: 3, scope: !4)
!48 = !DILocation(line: 24, column: 15, scope: !4)
!49 = !DILocation(line: 25, column: 3, scope: !4)
!50 = !DILocation(line: 26, column: 3, scope: !4)
!51 = !DILocation(line: 26, column: 15, scope: !4)
!52 = !DILocation(line: 27, column: 3, scope: !4)
!53 = !DILocation(line: 28, column: 3, scope: !4)
!54 = !DILocation(line: 28, column: 15, scope: !4)
!55 = !DILocation(line: 30, column: 3, scope: !4)
!56 = !DILocation(line: 31, column: 3, scope: !4)
!57 = !DILocation(line: 31, column: 15, scope: !4)
!58 = !DILocation(line: 32, column: 3, scope: !4)
!59 = !DILocation(line: 33, column: 3, scope: !4)
!60 = !DILocation(line: 33, column: 15, scope: !4)
!61 = !DILocation(line: 39, column: 3, scope: !4)
!62 = !DILocation(line: 40, column: 3, scope: !4)
!63 = !DILocation(line: 40, column: 15, scope: !4)
!64 = !DILocation(line: 41, column: 3, scope: !4)
!65 = !DILocation(line: 42, column: 3, scope: !4)
!66 = !DILocation(line: 42, column: 15, scope: !4)
!67 = !DILocation(line: 43, column: 3, scope: !4)
!68 = !DILocation(line: 44, column: 3, scope: !4)
!69 = !DILocation(line: 44, column: 15, scope: !4)
!70 = !DILocation(line: 45, column: 3, scope: !4)
!71 = !DILocation(line: 46, column: 3, scope: !4)
!72 = !DILocation(line: 46, column: 15, scope: !4)
!73 = !DILocation(line: 47, column: 3, scope: !4)
!74 = !DILocation(line: 48, column: 3, scope: !4)
!75 = !DILocation(line: 48, column: 15, scope: !4)
!76 = !DILocation(line: 49, column: 3, scope: !4)
!77 = !DILocation(line: 50, column: 3, scope: !4)
!78 = !DILocation(line: 50, column: 15, scope: !4)
!79 = !DILocation(line: 51, column: 3, scope: !4)
!80 = !DILocation(line: 52, column: 3, scope: !4)
!81 = !DILocation(line: 52, column: 15, scope: !4)
!82 = !DILocation(line: 53, column: 3, scope: !4)
!83 = !DILocation(line: 54, column: 3, scope: !4)
!84 = !DILocation(line: 54, column: 15, scope: !4)
!85 = !DILocation(line: 55, column: 3, scope: !4)
!86 = !DILocation(line: 56, column: 3, scope: !4)
!87 = !DILocation(line: 56, column: 15, scope: !4)
!88 = !DILocation(line: 57, column: 3, scope: !4)
!89 = !DILocation(line: 58, column: 3, scope: !4)
!90 = !DILocation(line: 58, column: 15, scope: !4)
!91 = !DILocation(line: 59, column: 3, scope: !4)
!92 = !DILocation(line: 60, column: 3, scope: !4)
!93 = !DILocation(line: 60, column: 15, scope: !4)
!94 = !DILocation(line: 61, column: 3, scope: !4)
!95 = !DILocation(line: 62, column: 3, scope: !4)
!96 = !DILocation(line: 62, column: 15, scope: !4)
!97 = !DILocation(line: 63, column: 3, scope: !4)
!98 = !DILocation(line: 64, column: 3, scope: !4)
!99 = !DILocation(line: 64, column: 15, scope: !4)
!100 = !DILocation(line: 65, column: 3, scope: !4)
!101 = !DILocation(line: 66, column: 3, scope: !4)
!102 = !DILocation(line: 66, column: 15, scope: !4)
!103 = !DILocation(line: 67, column: 3, scope: !4)
!104 = !DILocation(line: 68, column: 3, scope: !4)
!105 = !DILocation(line: 68, column: 15, scope: !4)
!106 = !DILocation(line: 69, column: 3, scope: !4)
!107 = !DILocation(line: 70, column: 3, scope: !4)
!108 = !DILocation(line: 70, column: 15, scope: !4)
!109 = !DILocation(line: 74, column: 3, scope: !4)
!110 = !DILocation(line: 75, column: 3, scope: !4)
!111 = !DILocation(line: 75, column: 15, scope: !4)
!112 = !DILocation(line: 76, column: 3, scope: !4)
!113 = !DILocation(line: 77, column: 3, scope: !4)
!114 = !DILocation(line: 77, column: 15, scope: !4)
!115 = !DILocation(line: 81, column: 3, scope: !4)
!116 = !DILocation(line: 82, column: 3, scope: !4)
!117 = !DILocation(line: 82, column: 15, scope: !4)
!118 = !DILocation(line: 83, column: 3, scope: !4)
!119 = !DILocation(line: 84, column: 3, scope: !4)
!120 = !DILocation(line: 84, column: 15, scope: !4)
!121 = !DILocation(line: 89, column: 3, scope: !4)
!122 = !DILocation(line: 90, column: 3, scope: !4)
!123 = !DILocation(line: 91, column: 3, scope: !4)
!124 = !DILocation(line: 92, column: 3, scope: !4)
!125 = !DILocation(line: 93, column: 3, scope: !4)
!126 = !DILocation(line: 98, column: 3, scope: !4)
!127 = !DILocation(line: 99, column: 5, scope: !128)
!128 = distinct !DILexicalBlock(scope: !4, file: !1, line: 98, column: 17)
!129 = !DILocation(line: 101, column: 5, scope: !130)
!130 = distinct !DILexicalBlock(scope: !4, file: !1, line: 100, column: 10)
!131 = !DILocation(line: 103, column: 3, scope: !4)
