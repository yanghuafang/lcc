...
if.end87:                                         ; preds = %if.end84, %then85
  %230 = load i32, i32* %err, align 4, !dbg !119
  %231 = icmp eq i32 %230, 0, !dbg !119
  %. = select i1 %231, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @1, i32 0, i32 0), !dbg !120
  %232 = call i32 (i8*, ...) @printf(i8* %.), !dbg !120
  %233 = load i32, i32* %err, align 4, !dbg !121
  ret i32 %233, !dbg !121
}
