...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %ui, metadata !9, metadata !DIExpression()), !dbg !11
  %si = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %si, metadata !12, metadata !DIExpression()), !dbg !13
  %ub = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %ub, metadata !14, metadata !DIExpression()), !dbg !15
  %ua = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %ua, metadata !16, metadata !DIExpression()), !dbg !17
  ...
  call void @llvm.dbg.declare(metadata i32* %v, metadata !24, metadata !DIExpression()), !dbg !25
  %f = alloca i1, align 1
  call void @llvm.dbg.declare(metadata i1* %f, metadata !26, metadata !DIExpression()), !dbg !28
  %t = alloca i1, align 1
  call void @llvm.dbg.declare(metadata i1* %t, metadata !29, metadata !DIExpression()), !dbg !30
  ...
  store i1 true, i1* %t, align 1, !dbg !30
  store i1 false, i1* %f, align 1, !dbg !28
  %0 = load i1, i1* %t, align 1, !dbg !33
...
then43:                                           ; preds = %if.end42
  ...
  %117 = load i32, i32* %err, align 4, !dbg !78
  br label %if.end45, !dbg !78

if.end45:                                         ; preds = %if.end42, %then43
  %118 = load i32, i32* %c, align 4, !dbg !79
  %119 = load i32, i32* %a, align 4, !dbg !79
  %120 = icmp slt i32 %118, %119, !dbg !79
  %121 = sext i1 %120 to i32, !dbg !79
  store i32 %121, i32* %v, align 4, !dbg !79
  %122 = load i32, i32* %v, align 4, !dbg !79
  %123 = load i32, i32* %v, align 4, !dbg !80
...
then46:                                           ; preds = %if.end45
  ...
  %125 = load i32, i32* %err, align 4, !dbg !81
  br label %if.end48, !dbg !81

if.end48:                                         ; preds = %if.end45, %then46
  %126 = load i32, i32* %a, align 4, !dbg !82
  %127 = load i32, i32* %b, align 4, !dbg !82
  %128 = icmp sle i32 %126, %127, !dbg !82
  %129 = sext i1 %128 to i32, !dbg !82
  store i32 %129, i32* %v, align 4, !dbg !82
  %130 = load i32, i32* %v, align 4, !dbg !82
  %131 = load i32, i32* %v, align 4, !dbg !83
...
then49:                                           ; preds = %if.end48
  ...
  %133 = load i32, i32* %err, align 4, !dbg !84
  br label %if.end51, !dbg !84

if.end51:                                         ; preds = %if.end48, %then49
  %134 = load i32, i32* %a, align 4, !dbg !85
  %135 = load i32, i32* %c, align 4, !dbg !85
  %136 = icmp sle i32 %134, %135, !dbg !85
  %137 = sext i1 %136 to i32, !dbg !85
  store i32 %137, i32* %v, align 4, !dbg !85
  %138 = load i32, i32* %v, align 4, !dbg !85
  %139 = load i32, i32* %v, align 4, !dbg !86
...
then52:                                           ; preds = %if.end51
  ...
  %141 = load i32, i32* %err, align 4, !dbg !87
  br label %if.end54, !dbg !87

if.end54:                                         ; preds = %if.end51, %then52
  %142 = load i32, i32* %c, align 4, !dbg !88
  %143 = load i32, i32* %a, align 4, !dbg !88
  %144 = icmp sle i32 %142, %143, !dbg !88
  %145 = sext i1 %144 to i32, !dbg !88
  store i32 %145, i32* %v, align 4, !dbg !88
  %146 = load i32, i32* %v, align 4, !dbg !88
  %147 = load i32, i32* %v, align 4, !dbg !89
  %148 = icmp ne i32 %147, 0, !dbg !89
  br i1 %148, label %then55, label %if.end57, !dbg !89

then55:                                           ; preds = %if.end54
  store i32 1, i32* %err, align 4, !dbg !90
  %149 = load i32, i32* %err, align 4, !dbg !90
  br label %if.end57, !dbg !90

if.end57:                                         ; preds = %if.end54, %then55
  %150 = load i32, i32* %a, align 4, !dbg !91
  %151 = load i32, i32* %b, align 4, !dbg !91
  %152 = icmp sgt i32 %150, %151, !dbg !91
  %153 = sext i1 %152 to i32, !dbg !91
  store i32 %153, i32* %v, align 4, !dbg !91
  %154 = load i32, i32* %v, align 4, !dbg !91
  %155 = load i32, i32* %v, align 4, !dbg !92
...
then58:                                           ; preds = %if.end57
  ...
  %157 = load i32, i32* %err, align 4, !dbg !93
  br label %if.end60, !dbg !93

if.end60:                                         ; preds = %if.end57, %then58
  %158 = load i32, i32* %a, align 4, !dbg !94
  %159 = load i32, i32* %c, align 4, !dbg !94
  %160 = icmp sgt i32 %158, %159, !dbg !94
  %161 = sext i1 %160 to i32, !dbg !94
  store i32 %161, i32* %v, align 4, !dbg !94
  %162 = load i32, i32* %v, align 4, !dbg !94
  %163 = load i32, i32* %v, align 4, !dbg !95
...
then61:                                           ; preds = %if.end60
  ...
  %165 = load i32, i32* %err, align 4, !dbg !96
  br label %if.end63, !dbg !96

if.end63:                                         ; preds = %if.end60, %then61
  %166 = load i32, i32* %c, align 4, !dbg !97
  %167 = load i32, i32* %a, align 4, !dbg !97
  %168 = icmp sgt i32 %166, %167, !dbg !97
  %169 = sext i1 %168 to i32, !dbg !97
  store i32 %169, i32* %v, align 4, !dbg !97
  %170 = load i32, i32* %v, align 4, !dbg !97
  %171 = load i32, i32* %v, align 4, !dbg !98
  %172 = icmp eq i32 %171, 0, !dbg !98
  br i1 %172, label %then64, label %if.end66, !dbg !98

then64:                                           ; preds = %if.end63
  store i32 1, i32* %err, align 4, !dbg !99
  %173 = load i32, i32* %err, align 4, !dbg !99
  br label %if.end66, !dbg !99

if.end66:                                         ; preds = %if.end63, %then64
  %174 = load i32, i32* %a, align 4, !dbg !100
  %175 = load i32, i32* %b, align 4, !dbg !100
  %176 = icmp sge i32 %174, %175, !dbg !100
  %177 = sext i1 %176 to i32, !dbg !100
  store i32 %177, i32* %v, align 4, !dbg !100
  %178 = load i32, i32* %v, align 4, !dbg !100
  %179 = load i32, i32* %v, align 4, !dbg !101
  %180 = icmp eq i32 %179, 0, !dbg !101
  br i1 %180, label %then67, label %if.end69, !dbg !101

then67:                                           ; preds = %if.end66
  store i32 1, i32* %err, align 4, !dbg !102
  %181 = load i32, i32* %err, align 4, !dbg !102
  br label %if.end69, !dbg !102

if.end69:                                         ; preds = %if.end66, %then67
  %182 = load i32, i32* %a, align 4, !dbg !103
  %183 = load i32, i32* %c, align 4, !dbg !103
  %184 = icmp sge i32 %182, %183, !dbg !103
  %185 = sext i1 %184 to i32, !dbg !103
  store i32 %185, i32* %v, align 4, !dbg !103
  %186 = load i32, i32* %v, align 4, !dbg !103
  %187 = load i32, i32* %v, align 4, !dbg !104
  %188 = icmp ne i32 %187, 0, !dbg !104
  br i1 %188, label %then70, label %if.end72, !dbg !104

then70:                                           ; preds = %if.end69
  store i32 1, i32* %err, align 4, !dbg !105
  %189 = load i32, i32* %err, align 4, !dbg !105
  br label %if.end72, !dbg !105

if.end72:                                         ; preds = %if.end69, %then70
  %190 = load i32, i32* %c, align 4, !dbg !106
  %191 = load i32, i32* %a, align 4, !dbg !106
  %192 = icmp sge i32 %190, %191, !dbg !106
  %193 = sext i1 %192 to i32, !dbg !106
  store i32 %193, i32* %v, align 4, !dbg !106
  %194 = load i32, i32* %v, align 4, !dbg !106
  %195 = load i32, i32* %v, align 4, !dbg !107
  %196 = icmp eq i32 %195, 0, !dbg !107
  br i1 %196, label %then73, label %if.end75, !dbg !107

then73:                                           ; preds = %if.end72
  store i32 1, i32* %err, align 4, !dbg !108
  %197 = load i32, i32* %err, align 4, !dbg !108
  br label %if.end75, !dbg !108

if.end75:                                         ; preds = %if.end72, %then73
  store i32 1, i32* %ua, align 4, !dbg !17
  store i32 -1, i32* %ub, align 4, !dbg !15
  %198 = load i32, i32* %ua, align 4, !dbg !109
  %199 = load i32, i32* %ub, align 4, !dbg !109
  %200 = icmp ult i32 %198, %199, !dbg !109
  %201 = sext i1 %200 to i32, !dbg !109
  store i32 %201, i32* %v, align 4, !dbg !109
  %202 = load i32, i32* %v, align 4, !dbg !109
  %203 = load i32, i32* %v, align 4, !dbg !110
  %204 = icmp eq i32 %203, 0, !dbg !110
  br i1 %204, label %then76, label %if.end78, !dbg !110

then76:                                           ; preds = %if.end75
  store i32 1, i32* %err, align 4, !dbg !111
  %205 = load i32, i32* %err, align 4, !dbg !111
  br label %if.end78, !dbg !111

if.end78:                                         ; preds = %if.end75, %then76
  %206 = load i32, i32* %ub, align 4, !dbg !112
  %207 = load i32, i32* %ua, align 4, !dbg !112
  %208 = icmp ugt i32 %206, %207, !dbg !112
  %209 = sext i1 %208 to i32, !dbg !112
  store i32 %209, i32* %v, align 4, !dbg !112
  %210 = load i32, i32* %v, align 4, !dbg !112
  %211 = load i32, i32* %v, align 4, !dbg !113
  %212 = icmp eq i32 %211, 0, !dbg !113
  br i1 %212, label %then79, label %if.end81, !dbg !113

then79:                                           ; preds = %if.end78
  store i32 1, i32* %err, align 4, !dbg !114
  %213 = load i32, i32* %err, align 4, !dbg !114
  br label %if.end81, !dbg !114

if.end81:                                         ; preds = %if.end78, %then79
  store i32 -1, i32* %si, align 4, !dbg !13
  store i32 1, i32* %ui, align 4, !dbg !11
  %214 = load i32, i32* %si, align 4, !dbg !115
  %215 = load i32, i32* %ui, align 4, !dbg !115
  %216 = icmp ult i32 %214, %215, !dbg !115
  %217 = sext i1 %216 to i32, !dbg !115
  store i32 %217, i32* %v, align 4, !dbg !115
  %218 = load i32, i32* %v, align 4, !dbg !115
  %219 = load i32, i32* %v, align 4, !dbg !116
  %220 = icmp ne i32 %219, 0, !dbg !116
  br i1 %220, label %then82, label %if.end84, !dbg !116

then82:                                           ; preds = %if.end81
  store i32 1, i32* %err, align 4, !dbg !117
  %221 = load i32, i32* %err, align 4, !dbg !117
  br label %if.end84, !dbg !117

if.end84:                                         ; preds = %if.end81, %then82
  %222 = load i32, i32* %si, align 4, !dbg !118
  %223 = load i32, i32* %ui, align 4, !dbg !118
  %224 = icmp ugt i32 %222, %223, !dbg !118
  %225 = sext i1 %224 to i32, !dbg !118
  store i32 %225, i32* %v, align 4, !dbg !118
  %226 = load i32, i32* %v, align 4, !dbg !118
  %227 = load i32, i32* %v, align 4, !dbg !119
  %228 = icmp eq i32 %227, 0, !dbg !119
  br i1 %228, label %then85, label %if.end87, !dbg !119

then85:                                           ; preds = %if.end84
  store i32 1, i32* %err, align 4, !dbg !120
  %229 = load i32, i32* %err, align 4, !dbg !120
  br label %if.end87, !dbg !120

if.end87:                                         ; preds = %if.end84, %then85
  %230 = load i32, i32* %err, align 4, !dbg !121
  %231 = icmp eq i32 %230, 0, !dbg !121
  %. = select i1 %231, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @1, i32 0, i32 0), !dbg !122
  %232 = call i32 (i8*, ...) @printf(i8* %.), !dbg !122
  %233 = load i32, i32* %err, align 4, !dbg !123
  ret i32 %233, !dbg !123
}
