...
entry:
  ...
  store i64 %const, ptr %a, align 4, !dbg !45
  store i64 %const43, ptr %b, align 4, !dbg !43
...
if.end15:                                         ; preds = %if.end6, %then7
  ...
  %20 = load i32, ptr %minusA, align 4, !dbg !56
...
then16:                                           ; preds = %if.end15
  ...
  %24 = load i32, ptr %err, align 4, !dbg !57
...
if.end21:                                         ; preds = %if.end15, %then16
  ...
  %25 = load i32, ptr %mulA, align 4, !dbg !58
  %26 = load i32, ptr %mulB, align 4, !dbg !58
  %27 = mul i32 %25, %26, !dbg !58
  %28 = load ptr, ptr %mulC, align 8, !dbg !58
  %29 = load i32, ptr %28, align 4, !dbg !58
...
if.end24:                                         ; preds = %if.end21, %then22
  ...
  %33 = load i64, ptr %callI, align 4, !dbg !60
  %34 = trunc i64 %33 to i32, !dbg !60
  call void @subFunc(i32 %34), !dbg !60
  %35 = load i64, ptr %callI, align 4, !dbg !61
