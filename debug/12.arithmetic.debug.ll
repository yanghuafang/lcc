...
if.end30:                                         ; preds = %if.end27, %then28
  ...
  %76 = load i32, ptr %ua, align 4, !dbg !77
  %77 = load i32, ptr %ub, align 4, !dbg !77
...
then31:                                           ; preds = %if.end30
  ...
  %80 = load i32, ptr %err, align 4, !dbg !78
  br label %if.end33, !dbg !78

if.end33:                                         ; preds = %if.end30, %then31
  %81 = load i32, ptr %ua, align 4, !dbg !79
  %82 = load i32, ptr %ub, align 4, !dbg !79
...
then34:                                           ; preds = %if.end33
  ...
  %85 = load i32, ptr %err, align 4, !dbg !80
...
if.end36:                                         ; preds = %if.end33, %then34
  ...
  %86 = load i32, ptr %negA, align 4, !dbg !81
  %87 = load i32, ptr %negB, align 4, !dbg !81
...
then37:                                           ; preds = %if.end36
  ...
  %90 = load i32, ptr %err, align 4, !dbg !82
...
if.end39:                                         ; preds = %if.end36, %then37
  ...
  %91 = load i32, ptr %mixedSi, align 4, !dbg !83
  %92 = load i32, ptr %mixedUi, align 4, !dbg !83
...
then40:                                           ; preds = %if.end39
  ...
  %95 = load i32, ptr %err, align 4, !dbg !84
  br label %if.end42, !dbg !84

if.end42:                                         ; preds = %if.end39, %then40
  %96 = load i32, ptr %err, align 4, !dbg !85
  %97 = icmp eq i32 %96, 0, !dbg !85
  %. = select i1 %97, ptr @0, ptr @1, !dbg !86
  %98 = call i32 (ptr, ...) @printf(ptr %.), !dbg !86
  %99 = load i32, ptr %err, align 4, !dbg !87
  ret i32 %99, !dbg !87
}
