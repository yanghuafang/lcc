...
if.end87:                                         ; preds = %else86, %then85
  ...
  store i32 %238, ptr %v, align 4
  %239 = load i32, ptr %v, align 4
  %240 = load i1, ptr %t, align 1
  %241 = load i1, ptr %t, align 1
  %242 = select i1 %240, i1 %241, i1 false
  %243 = sext i1 %242 to i32
  store i32 %243, ptr %v, align 4
  %244 = load i32, ptr %v, align 4
  %245 = load i1, ptr %t, align 1
  %246 = load i1, ptr %f, align 1
  %247 = select i1 %245, i1 true, i1 %246
  %248 = sext i1 %247 to i32
  store i32 %248, ptr %v, align 4
  %249 = load i32, ptr %v, align 4
  %250 = load i1, ptr %f, align 1
  %251 = icmp eq i1 %250, false
  %252 = sext i1 %251 to i32
  store i32 %252, ptr %v, align 4
  %253 = load i32, ptr %v, align 4
  %254 = load i32, ptr %err, align 4
  %255 = icmp eq i32 %254, 0
  br i1 %255, label %then88, label %else89

then88:                                           ; preds = %if.end87
  %256 = call i32 (ptr, ...) @printf(ptr @0)
  br label %if.end90

else89:                                           ; preds = %if.end87
  %257 = call i32 (ptr, ...) @printf(ptr @1)
  br label %if.end90
