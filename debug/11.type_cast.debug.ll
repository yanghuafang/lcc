...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %negToUint, metadata !9, metadata !DIExpression()), !dbg !11
  %ucharFromInt = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %ucharFromInt, metadata !12, metadata !DIExpression()), !dbg !14
  %intFromUchar = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %intFromUchar, metadata !15, metadata !DIExpression()), !dbg !16
  %ucharBoundary = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %ucharBoundary, metadata !17, metadata !DIExpression()), !dbg !18
  %floatVal2 = alloca float, align 4
  call void @llvm.dbg.declare(metadata float* %floatVal2, metadata !19, metadata !DIExpression()), !dbg !21
  %doubleVal2 = alloca double, align 8
  call void @llvm.dbg.declare(metadata double* %doubleVal2, metadata !22, metadata !DIExpression()), !dbg !24
  %doubleVal = alloca double, align 8
  call void @llvm.dbg.declare(metadata double* %doubleVal, metadata !25, metadata !DIExpression()), !dbg !26
  %floatVal = alloca float, align 4
  call void @llvm.dbg.declare(metadata float* %floatVal, metadata !27, metadata !DIExpression()), !dbg !28
  %longVal2 = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %longVal2, metadata !29, metadata !DIExpression()), !dbg !31
  %ulongVal2 = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %ulongVal2, metadata !32, metadata !DIExpression()), !dbg !34
  %ulongVal = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %ulongVal, metadata !35, metadata !DIExpression()), !dbg !36
  %longVal = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %longVal, metadata !37, metadata !DIExpression()), !dbg !38
  %intVal2 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %intVal2, metadata !39, metadata !DIExpression()), !dbg !40
  %uintVal2 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %uintVal2, metadata !41, metadata !DIExpression()), !dbg !42
  %uintVal = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %uintVal, metadata !43, metadata !DIExpression()), !dbg !44
  %intVal = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %intVal, metadata !45, metadata !DIExpression()), !dbg !46
  %charVal2 = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %charVal2, metadata !47, metadata !DIExpression()), !dbg !49
  %ucharVal2 = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %ucharVal2, metadata !50, metadata !DIExpression()), !dbg !51
  %ucharVal = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %ucharVal, metadata !52, metadata !DIExpression()), !dbg !53
  %charVal = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %charVal, metadata !54, metadata !DIExpression()), !dbg !55
  %err = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %err, metadata !56, metadata !DIExpression()), !dbg !57
  store i32 0, i32* %err, align 4, !dbg !57
  store i8 65, i8* %charVal, align 1, !dbg !55
  %0 = load i8, i8* %charVal, align 1, !dbg !53
  store i8 %0, i8* %ucharVal, align 1, !dbg !53
  %1 = load i8, i8* %charVal, align 1, !dbg !51
  store i8 %1, i8* %ucharVal2, align 1, !dbg !51
  %2 = load i8, i8* %ucharVal, align 1, !dbg !49
  store i8 %2, i8* %charVal2, align 1, !dbg !49
  %3 = load i8, i8* %charVal, align 1, !dbg !46
  %4 = sext i8 %3 to i32, !dbg !46
  store i32 %4, i32* %intVal, align 4, !dbg !46
  %5 = load i32, i32* %intVal, align 4, !dbg !44
  store i32 %5, i32* %uintVal, align 4, !dbg !44
  %6 = load i32, i32* %intVal, align 4, !dbg !42
  store i32 %6, i32* %uintVal2, align 4, !dbg !42
  %7 = load i32, i32* %uintVal, align 4, !dbg !40
  store i32 %7, i32* %intVal2, align 4, !dbg !40
  %8 = load i32, i32* %intVal, align 4, !dbg !38
  %9 = sext i32 %8 to i64, !dbg !38
  store i64 %9, i64* %longVal, align 4, !dbg !38
  %10 = load i64, i64* %longVal, align 4, !dbg !36
  store i64 %10, i64* %ulongVal, align 4, !dbg !36
  %11 = load i64, i64* %longVal, align 4, !dbg !34
  store i64 %11, i64* %ulongVal2, align 4, !dbg !34
  %12 = load i64, i64* %ulongVal2, align 4, !dbg !31
  store i64 %12, i64* %longVal2, align 4, !dbg !31
  store float 0x400921FB40000000, float* %floatVal, align 4, !dbg !28
  %13 = load float, float* %floatVal, align 4, !dbg !26
  %14 = fpext float %13 to double, !dbg !26
  store double %14, double* %doubleVal, align 8, !dbg !26
  %15 = load float, float* %floatVal, align 4, !dbg !24
  %16 = fpext float %15 to double, !dbg !24
  store double %16, double* %doubleVal2, align 8, !dbg !24
  %17 = load double, double* %doubleVal, align 8, !dbg !21
  %18 = fptrunc double %17 to float, !dbg !21
  store float %18, float* %floatVal2, align 4, !dbg !21
  %19 = load i8, i8* %charVal2, align 1, !dbg !58
  %20 = sext i8 %19 to i32, !dbg !58
  %21 = icmp ne i32 %20, 65, !dbg !58
  br i1 %21, label %then, label %if.end, !dbg !58

then:                                             ; preds = %entry
  store i32 1, i32* %err, align 4, !dbg !59
  %22 = load i32, i32* %err, align 4, !dbg !59
  br label %if.end, !dbg !59

if.end:                                           ; preds = %entry, %then
  %23 = load i8, i8* %ucharVal, align 1, !dbg !60
  %24 = zext i8 %23 to i32, !dbg !60
  %25 = icmp ne i32 %24, 65, !dbg !60
  br i1 %25, label %then1, label %if.end3, !dbg !60

then1:                                            ; preds = %if.end
  store i32 1, i32* %err, align 4, !dbg !61
  %26 = load i32, i32* %err, align 4, !dbg !61
  br label %if.end3, !dbg !61

if.end3:                                          ; preds = %if.end, %then1
  %27 = load i32, i32* %intVal, align 4, !dbg !62
  %28 = icmp ne i32 %27, 65, !dbg !62
  br i1 %28, label %then4, label %if.end6, !dbg !62

then4:                                            ; preds = %if.end3
  store i32 1, i32* %err, align 4, !dbg !63
  %29 = load i32, i32* %err, align 4, !dbg !63
  br label %if.end6, !dbg !63

if.end6:                                          ; preds = %if.end3, %then4
  %30 = load i32, i32* %uintVal, align 4, !dbg !64
  %31 = icmp ne i32 %30, 65, !dbg !64
  br i1 %31, label %then7, label %if.end9, !dbg !64

then7:                                            ; preds = %if.end6
  store i32 1, i32* %err, align 4, !dbg !65
  %32 = load i32, i32* %err, align 4, !dbg !65
  br label %if.end9, !dbg !65

if.end9:                                          ; preds = %if.end6, %then7
  %33 = load i32, i32* %intVal2, align 4, !dbg !66
  %34 = icmp ne i32 %33, 65, !dbg !66
  br i1 %34, label %then10, label %if.end12, !dbg !66

then10:                                           ; preds = %if.end9
  store i32 1, i32* %err, align 4, !dbg !67
  %35 = load i32, i32* %err, align 4, !dbg !67
  br label %if.end12, !dbg !67

if.end12:                                         ; preds = %if.end9, %then10
  %36 = load i64, i64* %longVal, align 4, !dbg !68
  %37 = trunc i64 %36 to i32, !dbg !68
  %38 = icmp ne i32 %37, 65, !dbg !68
  br i1 %38, label %then13, label %if.end15, !dbg !68

then13:                                           ; preds = %if.end12
  store i32 1, i32* %err, align 4, !dbg !69
  %39 = load i32, i32* %err, align 4, !dbg !69
  br label %if.end15, !dbg !69

if.end15:                                         ; preds = %if.end12, %then13
  %40 = load i64, i64* %ulongVal, align 4, !dbg !70
  %41 = trunc i64 %40 to i32, !dbg !70
  %42 = icmp ne i32 %41, 65, !dbg !70
  br i1 %42, label %then16, label %if.end18, !dbg !70

then16:                                           ; preds = %if.end15
  store i32 1, i32* %err, align 4, !dbg !71
  %43 = load i32, i32* %err, align 4, !dbg !71
  br label %if.end18, !dbg !71

if.end18:                                         ; preds = %if.end15, %then16
  %44 = load i64, i64* %longVal2, align 4, !dbg !72
  %45 = trunc i64 %44 to i32, !dbg !72
  %46 = icmp ne i32 %45, 65, !dbg !72
  br i1 %46, label %then19, label %if.end21, !dbg !72

then19:                                           ; preds = %if.end18
  store i32 1, i32* %err, align 4, !dbg !73
  %47 = load i32, i32* %err, align 4, !dbg !73
  br label %if.end21, !dbg !73

if.end21:                                         ; preds = %if.end18, %then19
  store i8 -6, i8* %ucharBoundary, align 1, !dbg !18
  %48 = load i8, i8* %ucharBoundary, align 1, !dbg !16
  %49 = zext i8 %48 to i32, !dbg !16
  store i32 %49, i32* %intFromUchar, align 4, !dbg !16
  %50 = load i32, i32* %intFromUchar, align 4, !dbg !74
  %51 = icmp ne i32 %50, 250, !dbg !74
  br i1 %51, label %then22, label %if.end24, !dbg !74

then22:                                           ; preds = %if.end21
  store i32 1, i32* %err, align 4, !dbg !75
  %52 = load i32, i32* %err, align 4, !dbg !75
  br label %if.end24, !dbg !75

if.end24:                                         ; preds = %if.end21, %then22
  %53 = load i32, i32* %intFromUchar, align 4, !dbg !14
  %54 = trunc i32 %53 to i8, !dbg !14
  store i8 %54, i8* %ucharFromInt, align 1, !dbg !14
  %55 = load i8, i8* %ucharFromInt, align 1, !dbg !76
  %56 = zext i8 %55 to i32, !dbg !76
  %57 = icmp ne i32 %56, 250, !dbg !76
  br i1 %57, label %then25, label %if.end27, !dbg !76

then25:                                           ; preds = %if.end24
  store i32 1, i32* %err, align 4, !dbg !77
  %58 = load i32, i32* %err, align 4, !dbg !77
  br label %if.end27, !dbg !77

if.end27:                                         ; preds = %if.end24, %then25
  store i32 -1, i32* %negToUint, align 4, !dbg !11
  %59 = load i32, i32* %negToUint, align 4, !dbg !78
  %60 = icmp ne i32 %59, -1, !dbg !78
  br i1 %60, label %then28, label %if.end30, !dbg !78

then28:                                           ; preds = %if.end27
  store i32 1, i32* %err, align 4, !dbg !79
  %61 = load i32, i32* %err, align 4, !dbg !79
  br label %if.end30, !dbg !79

if.end30:                                         ; preds = %if.end27, %then28
  %62 = load i32, i32* %err, align 4, !dbg !80
  %63 = icmp eq i32 %62, 0, !dbg !80
  %. = select i1 %63, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @1, i32 0, i32 0), !dbg !81
  %64 = call i32 (i8*, ...) @printf(i8* %.), !dbg !81
  %65 = load i32, i32* %err, align 4, !dbg !82
  ret i32 %65, !dbg !82
}
