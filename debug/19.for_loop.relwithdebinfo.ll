...
define i32 @countSum3(i32 %0) !dbg !10 {
entry:
  %i = alloca i32, align 4
  %sum = alloca i32, align 4
  %n = alloca i32, align 4
  store i32 %0, i32* %n, align 4, !dbg !11
  store i32 0, i32* %sum, align 4, !dbg !11
...
for.cond:                                         ; preds = %for.loop, %entry
  ...
  %3 = load i32, i32* %n, align 4, !dbg !11
  %4 = icmp sle i32 %2, %3, !dbg !11
  br i1 %4, label %for.loop, label %for.end, !dbg !11

for.loop:                                         ; preds = %for.cond
  %5 = load i32, i32* %i, align 4, !dbg !11
  %6 = load i32, i32* %sum, align 4, !dbg !11
  %7 = add i32 %6, %5, !dbg !11
  store i32 %7, i32* %sum, align 4, !dbg !11
  %8 = load i32, i32* %sum, align 4, !dbg !11
  %9 = load i32, i32* %i, align 4, !dbg !11
  %10 = add i32 %9, 1, !dbg !11
  store i32 %10, i32* %i, align 4, !dbg !11
  %11 = load i32, i32* %i, align 4, !dbg !11
  br label %for.cond, !dbg !11

for.end:                                          ; preds = %for.cond
  %12 = load i32, i32* %sum, align 4, !dbg !11
  ret i32 %12, !dbg !11
}
...
entry:
  ...
  %0 = call i32 @countSum(i32 100), !dbg !15
  %1 = icmp ne i32 %0, 5050, !dbg !15
...
if.end:                                           ; preds = %entry, %then
  %3 = call i32 @countSum2(i32 100), !dbg !15
  %4 = icmp ne i32 %3, 5050, !dbg !15
...
if.end3:                                          ; preds = %if.end, %then1
  %6 = call i32 @countSum3(i32 100), !dbg !15
  %7 = icmp ne i32 %6, 5050, !dbg !15
...
if.end6:                                          ; preds = %if.end3, %then4
  %9 = call i32 @countSum(i32 0), !dbg !15
...
if.end9:                                          ; preds = %if.end6, %then7
  %12 = call i32 @countSum(i32 1), !dbg !15
...
!10 = distinct !DISubprogram(name: "countSum3", linkageName: "countSum3", scope: null, file: !1, line: 1, type: !3, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !6)
