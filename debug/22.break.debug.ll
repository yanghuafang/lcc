...
for.cond:                                         ; preds = %if.end, %entry
  ...
  %3 = load i32, i32* %maxRange, align 4, !dbg !10
...
if.end:                                           ; preds = %for.loop
  %8 = load i32, i32* %count, align 4, !dbg !18
  %9 = add i32 %8, 1, !dbg !18
  store i32 %9, i32* %count, align 4, !dbg !18
  %10 = load i32, i32* %count, align 4, !dbg !18
  %11 = load i32, i32* %i, align 4, !dbg !18
  %12 = add i32 %11, 1, !dbg !18
  store i32 %12, i32* %i, align 4, !dbg !18
  %13 = load i32, i32* %i, align 4, !dbg !18
  br label %for.cond, !dbg !18

for.end:                                          ; preds = %for.loop, %for.cond
  %14 = load i32, i32* %count, align 4, !dbg !19
  ret i32 %14, !dbg !19
}
...
entry:
  ...
  %count = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %count, metadata !23, metadata !DIExpression()), !dbg !24
  %smallRange = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %smallRange, metadata !25, metadata !DIExpression()), !dbg !26
  %maxRange = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %maxRange, metadata !27, metadata !DIExpression()), !dbg !26
  store i32 %0, i32* %maxRange, align 4, !dbg !26
  store i32 %1, i32* %smallRange, align 4, !dbg !26
  store i32 0, i32* %count, align 4, !dbg !24
  store i32 1, i32* %i, align 4, !dbg !22
  br label %while.cond, !dbg !28

while.cond:                                       ; preds = %if.end, %entry
  %2 = load i32, i32* %i, align 4, !dbg !28
  %3 = load i32, i32* %maxRange, align 4, !dbg !28
  %4 = icmp sle i32 %2, %3, !dbg !28
  br i1 %4, label %while.loop, label %while.end, !dbg !28

while.loop:                                       ; preds = %while.cond
  %5 = load i32, i32* %i, align 4, !dbg !29
  %6 = load i32, i32* %smallRange, align 4, !dbg !29
  %7 = icmp sgt i32 %5, %6, !dbg !29
  br i1 %7, label %while.end, label %if.end, !dbg !29

if.end:                                           ; preds = %while.loop
  %8 = load i32, i32* %count, align 4, !dbg !31
  %9 = add i32 %8, 1, !dbg !31
  store i32 %9, i32* %count, align 4, !dbg !31
  %10 = load i32, i32* %count, align 4, !dbg !31
...
while.end:                                        ; preds = %while.loop, %while.cond
  %14 = load i32, i32* %count, align 4, !dbg !33
  ret i32 %14, !dbg !33
}
...
entry:
  ...
  %smallRange = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %smallRange, metadata !39, metadata !DIExpression()), !dbg !40
  %maxRange = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %maxRange, metadata !41, metadata !DIExpression()), !dbg !40
  store i32 %0, i32* %maxRange, align 4, !dbg !40
  store i32 %1, i32* %smallRange, align 4, !dbg !40
...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %err, metadata !51, metadata !DIExpression()), !dbg !52
  store i32 0, i32* %err, align 4, !dbg !52
...
then:                                             ; preds = %entry
  ...
  %2 = load i32, i32* %err, align 4, !dbg !54
...
then1:                                            ; preds = %if.end
  ...
  %5 = load i32, i32* %err, align 4, !dbg !56
...
then4:                                            ; preds = %if.end3
  ...
  %8 = load i32, i32* %err, align 4, !dbg !58
...
then7:                                            ; preds = %if.end6
  ...
  %11 = load i32, i32* %err, align 4, !dbg !60
...
then10:                                           ; preds = %if.end9
  ...
  %14 = load i32, i32* %err, align 4, !dbg !62
...
then13:                                           ; preds = %if.end12
  ...
  %17 = load i32, i32* %err, align 4, !dbg !64
...
then16:                                           ; preds = %if.end15
  ...
  %20 = load i32, i32* %err, align 4, !dbg !66
...
then19:                                           ; preds = %if.end18
  ...
  %23 = load i32, i32* %err, align 4, !dbg !68
...
then22:                                           ; preds = %if.end21
  ...
  %26 = load i32, i32* %err, align 4, !dbg !70
  br label %if.end24, !dbg !70

if.end24:                                         ; preds = %if.end21, %then22
  %27 = load i32, i32* %err, align 4, !dbg !71
  %28 = icmp eq i32 %27, 0, !dbg !71
  %. = select i1 %28, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @1, i32 0, i32 0), !dbg !72
  %29 = call i32 (i8*, ...) @printf(i8* %.), !dbg !72
  %30 = load i32, i32* %err, align 4, !dbg !73
  ret i32 %30, !dbg !73
}
