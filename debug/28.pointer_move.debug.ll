...
entry:
  ...
  br i1 %11, label %then, label %if.end, !dbg !22
...
if.end:                                           ; preds = %entry, %then
  ...
  br i1 %19, label %then1, label %if.end3, !dbg !25
...
if.end3:                                          ; preds = %if.end, %then1
  ...
  br i1 %27, label %then4, label %if.end6, !dbg !28
...
if.end6:                                          ; preds = %if.end3, %then4
  ...
  br i1 %34, label %then7, label %if.end9, !dbg !31
...
if.end9:                                          ; preds = %if.end6, %then7
  ...
  br i1 %41, label %then10, label %if.end12, !dbg !34
...
if.end12:                                         ; preds = %if.end9, %then10
  ...
  br i1 %49, label %then13, label %if.end15, !dbg !37
...
if.end15:                                         ; preds = %if.end12, %then13
  ...
  br i1 %57, label %then16, label %if.end18, !dbg !40
...
if.end18:                                         ; preds = %if.end15, %then16
  ...
  br i1 %64, label %then19, label %if.end21, !dbg !43
...
if.end21:                                         ; preds = %if.end18, %then19
  ...
  %. = select i1 %67, ptr @0, ptr @1, !dbg !46
  %68 = call i32 (ptr, ...) @printf(ptr %.), !dbg !46
...
!6 = !{}
!7 = !DILocalVariable(name: "pc", scope: !2, file: !1, line: 14, type: !8)
!8 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !9, size: 64)
!9 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!10 = !DILocation(line: 14, column: 3, scope: !2)
!11 = !DILocalVariable(name: "c", scope: !2, file: !1, line: 8, type: !12)
...
!44 = !DILocation(line: 30, column: 19, scope: !2)
