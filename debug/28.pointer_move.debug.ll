...
if.end:                                           ; preds = %entry, %then
  ...
  br i1 %19, label %then1, label %if.end3, !dbg !27
...
if.end3:                                          ; preds = %if.end, %then1
  ...
  br i1 %27, label %then4, label %if.end6, !dbg !30
...
if.end6:                                          ; preds = %if.end3, %then4
  ...
  br i1 %34, label %then7, label %if.end9, !dbg !33
...
if.end9:                                          ; preds = %if.end6, %then7
  ...
  br i1 %41, label %then10, label %if.end12, !dbg !36
...
if.end12:                                         ; preds = %if.end9, %then10
  ...
  br i1 %49, label %then13, label %if.end15, !dbg !39
...
if.end15:                                         ; preds = %if.end12, %then13
  ...
  br i1 %57, label %then16, label %if.end18, !dbg !42
...
if.end18:                                         ; preds = %if.end15, %then16
  ...
  br i1 %64, label %then19, label %if.end21, !dbg !45
...
if.end21:                                         ; preds = %if.end18, %then19
  ...
  %. = select i1 %67, ptr @0, ptr @1, !dbg !48
  %68 = call i32 (ptr, ...) @printf(ptr %.), !dbg !48
  %69 = load i32, ptr %err, align 4, !dbg !49
  ret i32 %69, !dbg !49
}
