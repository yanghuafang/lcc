...
entry:
  ...
  %0 = bitcast ptr %la to ptr, !dbg !18
  ...
  %6 = bitcast ptr %lb to ptr, !dbg !16
  ...
  %12 = bitcast ptr %lc to ptr, !dbg !14
  ...
  %18 = bitcast ptr %la to ptr, !dbg !21
  %19 = bitcast ptr %18 to ptr, !dbg !21
  %20 = load i32, ptr %19, align 4, !dbg !21
  %21 = icmp ne i32 %20, 1, !dbg !21
  br i1 %21, label %then, label %if.end, !dbg !21
...
if.end3:                                          ; preds = %if.end, %then1
  ...
  br i1 %31, label %then4, label %if.end6, !dbg !25
...
if.end6:                                          ; preds = %if.end3, %then4
  ...
  br i1 %36, label %then7, label %if.end9, !dbg !27
...
if.end9:                                          ; preds = %if.end6, %then7
  %38 = bitcast ptr %lb to ptr, !dbg !29
  %39 = bitcast ptr %38 to ptr, !dbg !29
  %40 = load i32, ptr %39, align 4, !dbg !29
  %41 = icmp ne i32 %40, 7, !dbg !29
  br i1 %41, label %then10, label %if.end12, !dbg !29
...
if.end12:                                         ; preds = %if.end9, %then10
  ...
  br i1 %46, label %then13, label %if.end15, !dbg !31
...
if.end18:                                         ; preds = %if.end15, %then16
  ...
  br i1 %56, label %then19, label %if.end21, !dbg !35
...
if.end21:                                         ; preds = %if.end18, %then19
  ...
  br i1 %61, label %then22, label %if.end24, !dbg !37
...
if.end24:                                         ; preds = %if.end21, %then22
  ...
  br i1 %64, label %then25, label %if.end27, !dbg !39
...
if.end27:                                         ; preds = %if.end24, %then25
  ...
  br i1 %67, label %then28, label %if.end30, !dbg !41
...
if.end30:                                         ; preds = %if.end27, %then28
  ...
  br i1 %70, label %then31, label %if.end33, !dbg !43
...
if.end33:                                         ; preds = %if.end30, %then31
  ...
  br i1 %73, label %then34, label %if.end36, !dbg !45
...
if.end36:                                         ; preds = %if.end33, %then34
  ...
  br i1 %76, label %then37, label %if.end39, !dbg !47
...
if.end39:                                         ; preds = %if.end36, %then37
  ...
  br i1 %79, label %then40, label %if.end42, !dbg !49
...
if.end42:                                         ; preds = %if.end39, %then40
  ...
  br i1 %82, label %then43, label %if.end45, !dbg !51
...
if.end45:                                         ; preds = %if.end42, %then43
  ...
  %. = select i1 %85, ptr @0, ptr @1, !dbg !54
  %86 = call i32 (ptr, ...) @printf(ptr %.), !dbg !54
  %87 = load i32, ptr %err, align 4, !dbg !55
  ret i32 %87, !dbg !55
}
