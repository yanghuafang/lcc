...
if.end30:                                         ; preds = %if.end27, %then28
  ...
  %76 = load i32, i32* %ua, align 4, !dbg !75
  %77 = load i32, i32* %ub, align 4, !dbg !75
...
then31:                                           ; preds = %if.end30
  ...
  %80 = load i32, i32* %err, align 4, !dbg !76
  br label %if.end33, !dbg !76

if.end33:                                         ; preds = %if.end30, %then31
  %81 = load i32, i32* %ua, align 4, !dbg !77
  %82 = load i32, i32* %ub, align 4, !dbg !77
...
then34:                                           ; preds = %if.end33
  ...
  %85 = load i32, i32* %err, align 4, !dbg !78
...
if.end36:                                         ; preds = %if.end33, %then34
  ...
  %86 = load i32, i32* %negA, align 4, !dbg !79
  %87 = load i32, i32* %negB, align 4, !dbg !79
...
then37:                                           ; preds = %if.end36
  ...
  %90 = load i32, i32* %err, align 4, !dbg !80
...
if.end39:                                         ; preds = %if.end36, %then37
  ...
  %91 = load i32, i32* %mixedSi, align 4, !dbg !81
  %92 = load i32, i32* %mixedUi, align 4, !dbg !81
...
then40:                                           ; preds = %if.end39
  ...
  %95 = load i32, i32* %err, align 4, !dbg !82
  br label %if.end42, !dbg !82

if.end42:                                         ; preds = %if.end39, %then40
  %96 = load i32, i32* %err, align 4, !dbg !83
  %97 = icmp eq i32 %96, 0, !dbg !83
  %. = select i1 %97, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @1, i32 0, i32 0), !dbg !84
  %98 = call i32 (i8*, ...) @printf(i8* %.), !dbg !84
  %99 = load i32, i32* %err, align 4, !dbg !85
  ret i32 %99, !dbg !85
}
