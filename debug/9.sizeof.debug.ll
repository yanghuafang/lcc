...
entry:
  ...
  %0 = load i32, i32* %err, align 4, !dbg !8
  %1 = icmp eq i32 %0, 0, !dbg !8
  %. = select i1 %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @1, i32 0, i32 0), !dbg !9
  %2 = call i32 (i8*, ...) @printf(i8* %.), !dbg !9
  %3 = load i32, i32* %err, align 4, !dbg !10
  ret i32 %3, !dbg !10
}
...
!8 = !DILocation(line: 42, column: 3, scope: !2)
