...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %l, metadata !11, metadata !DIExpression()), !dbg !10
  store i32 %0, i32* %l, align 4, !dbg !10
  store i32 %1, i32* %r, align 4, !dbg !10
  %2 = load i32, i32* %l, align 4, !dbg !12
  %3 = load i32, i32* %r, align 4, !dbg !12
  %4 = add i32 %2, %3, !dbg !12
  ret i32 %4, !dbg !12
}

define i32 @sum2(i32* %0, i32* %1) !dbg !13 {
entry:
  %r = alloca i32*, align 8
  call void @llvm.dbg.declare(metadata i32** %r, metadata !17, metadata !DIExpression()), !dbg !18
  %l = alloca i32*, align 8
  call void @llvm.dbg.declare(metadata i32** %l, metadata !19, metadata !DIExpression()), !dbg !18
  store i32* %0, i32** %l, align 8, !dbg !18
  store i32* %1, i32** %r, align 8, !dbg !18
  %2 = load i32*, i32** %l, align 8, !dbg !20
  %3 = load i32, i32* %2, align 4, !dbg !20
  %4 = load i32*, i32** %r, align 8, !dbg !20
...
define void @sum3(i32 %0, i32 %1, i32* %2) !dbg !21 {
entry:
  %result = alloca i32*, align 8
  call void @llvm.dbg.declare(metadata i32** %result, metadata !25, metadata !DIExpression()), !dbg !26
  %r = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %r, metadata !27, metadata !DIExpression()), !dbg !26
  %l = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %l, metadata !28, metadata !DIExpression()), !dbg !26
  store i32 %0, i32* %l, align 4, !dbg !26
  store i32 %1, i32* %r, align 4, !dbg !26
  store i32* %2, i32** %result, align 8, !dbg !26
  %3 = load i32*, i32** %result, align 8, !dbg !29
  %4 = load i32, i32* %l, align 4, !dbg !29
  %5 = load i32, i32* %r, align 4, !dbg !29
...
entry:
  ...
  %l = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %l, metadata !35, metadata !DIExpression()), !dbg !36
  ...
  store i32 3, i32* %l, align 4, !dbg !36
  store i32 4, i32* %r, align 4, !dbg !34
...
then:                                             ; preds = %entry
  ...
  %2 = load i32, i32* %err, align 4, !dbg !42
...
then1:                                            ; preds = %if.end
  ...
  %5 = load i32, i32* %err, align 4, !dbg !44
  br label %if.end3, !dbg !44

if.end3:                                          ; preds = %if.end, %then1
  %6 = load i32, i32* %l, align 4, !dbg !45
  %7 = load i32, i32* %r, align 4, !dbg !45
...
then10:                                           ; preds = %if.end9
  ...
  %16 = load i32, i32* %err, align 4, !dbg !51
  br label %if.end12, !dbg !51

if.end12:                                         ; preds = %if.end9, %then10
  %17 = load i32, i32* %l, align 4, !dbg !52
  %18 = load i32, i32* %r, align 4, !dbg !52
  call void @sum3(i32 %17, i32 %18, i32* %i), !dbg !52
  %19 = load i32, i32* %i, align 4, !dbg !53
  %20 = icmp ne i32 %19, 7, !dbg !53
  br i1 %20, label %then13, label %if.end15, !dbg !53

then13:                                           ; preds = %if.end12
  store i32 1, i32* %err, align 4, !dbg !54
  %21 = load i32, i32* %err, align 4, !dbg !54
...
then16:                                           ; preds = %if.end15
  ...
  %24 = load i32, i32* %err, align 4, !dbg !56
  br label %if.end18, !dbg !56

if.end18:                                         ; preds = %if.end15, %then16
  %25 = load i32, i32* %err, align 4, !dbg !57
  %26 = icmp eq i32 %25, 0, !dbg !57
  %. = select i1 %26, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @1, i32 0, i32 0), !dbg !58
  %27 = call i32 (i8*, ...) @printf(i8* %.), !dbg !58
  %28 = load i32, i32* %err, align 4, !dbg !59
  ret i32 %28, !dbg !59
}
