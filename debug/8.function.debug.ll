...
entry:
  ...
  br i1 %1, label %then, label %else, !dbg !41
...
if.end:                                           ; preds = %else, %then
  ...
  br i1 %4, label %then1, label %else2, !dbg !43
...
if.end9:                                          ; preds = %else8, %then7
  ...
  br i1 %15, label %then10, label %else11, !dbg !50
...
if.end12:                                         ; preds = %else11, %then10
  ...
  br i1 %20, label %then13, label %else14, !dbg !53
...
if.end15:                                         ; preds = %else14, %then13
  ...
  br i1 %23, label %then16, label %else17, !dbg !55
...
if.end18:                                         ; preds = %else17, %then16
  ...
  br i1 %26, label %then19, label %else20, !dbg !57

then19:                                           ; preds = %if.end18
  %27 = call i32 (ptr, ...) @printf(ptr @0), !dbg !58
  br label %if.end21, !dbg !58

else20:                                           ; preds = %if.end18
  %28 = call i32 (ptr, ...) @printf(ptr @1), !dbg !60
...
!4 = distinct !DISubprogram(name: "sum", linkageName: "sum", scope: null, file: !3, line: 9, type: !5, scopeLine: 9, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !8)
!5 = !DISubroutineType(types: !6)
!6 = !{!7, !7, !7}
!7 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!8 = !{}
!9 = !DILocalVariable(name: "r", arg: 2, scope: !4, file: !3, line: 9, type: !7)
!10 = !DILocation(line: 9, column: 5, scope: !4)
!11 = !DILocalVariable(name: "l", arg: 1, scope: !4, file: !3, line: 9, type: !7)
!12 = !DILocation(line: 9, column: 25, scope: !4)
!13 = distinct !DISubprogram(name: "sum2", linkageName: "sum2", scope: null, file: !3, line: 7, type: !14, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !8)
!14 = !DISubroutineType(types: !15)
!15 = !{!7, !16, !16}
!16 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7, size: 64)
!17 = !DILocalVariable(name: "r", arg: 2, scope: !13, file: !3, line: 7, type: !16)
!18 = !DILocation(line: 7, column: 5, scope: !13)
!19 = !DILocalVariable(name: "l", arg: 1, scope: !13, file: !3, line: 7, type: !16)
!20 = !DILocation(line: 7, column: 28, scope: !13)
!21 = distinct !DISubprogram(name: "sum3", linkageName: "sum3", scope: null, file: !3, line: 8, type: !22, scopeLine: 8, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !8)
!22 = !DISubroutineType(types: !23)
!23 = !{!24, !7, !7, !16}
!24 = !DIBasicType(name: "void", encoding: DW_ATE_address)
!25 = !DILocalVariable(name: "result", arg: 3, scope: !21, file: !3, line: 8, type: !16)
!26 = !DILocation(line: 8, column: 6, scope: !21)
!27 = !DILocalVariable(name: "r", arg: 2, scope: !21, file: !3, line: 8, type: !7)
!28 = !DILocalVariable(name: "l", arg: 1, scope: !21, file: !3, line: 8, type: !7)
!29 = !DILocation(line: 8, column: 40, scope: !21)
!30 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 11, type: !31, scopeLine: 11, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !8)
!31 = !DISubroutineType(types: !32)
!32 = !{!7}
!33 = !DILocalVariable(name: "r", scope: !30, file: !3, line: 15, type: !7)
!34 = !DILocation(line: 15, column: 3, scope: !30)
!35 = !DILocalVariable(name: "l", scope: !30, file: !3, line: 14, type: !7)
!36 = !DILocation(line: 14, column: 3, scope: !30)
!37 = !DILocalVariable(name: "i", scope: !30, file: !3, line: 13, type: !7)
!38 = !DILocation(line: 13, column: 3, scope: !30)
!39 = !DILocalVariable(name: "err", scope: !30, file: !3, line: 12, type: !7)
!40 = !DILocation(line: 12, column: 3, scope: !30)
!41 = !DILocation(line: 17, column: 3, scope: !30)
!42 = !DILocation(line: 17, column: 23, scope: !30)
!43 = !DILocation(line: 18, column: 3, scope: !30)
!44 = !DILocation(line: 18, column: 23, scope: !30)
!45 = !DILocation(line: 19, column: 3, scope: !30)
!46 = !DILocation(line: 19, column: 23, scope: !30)
!47 = !DILocation(line: 20, column: 3, scope: !30)
!48 = !DILocation(line: 20, column: 26, scope: !30)
!49 = !DILocation(line: 22, column: 3, scope: !30)
!50 = !DILocation(line: 23, column: 3, scope: !30)
!51 = !DILocation(line: 23, column: 15, scope: !30)
!52 = !DILocation(line: 24, column: 3, scope: !30)
!53 = !DILocation(line: 25, column: 3, scope: !30)
!54 = !DILocation(line: 25, column: 15, scope: !30)
!55 = !DILocation(line: 27, column: 3, scope: !30)
!56 = !DILocation(line: 27, column: 41, scope: !30)
!57 = !DILocation(line: 29, column: 3, scope: !30)
!58 = !DILocation(line: 30, column: 5, scope: !59)
!59 = distinct !DILexicalBlock(scope: !30, file: !3, line: 29, column: 17)
!60 = !DILocation(line: 32, column: 5, scope: !61)
!61 = distinct !DILexicalBlock(scope: !30, file: !3, line: 31, column: 10)
!62 = !DILocation(line: 34, column: 3, scope: !30)
