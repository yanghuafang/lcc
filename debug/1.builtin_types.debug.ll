...
entry:
  ...
  call void @llvm.dbg.declare(metadata i1* %bf, metadata !9, metadata !DIExpression()), !dbg !11
  %bt = alloca i1, align 1
  call void @llvm.dbg.declare(metadata i1* %bt, metadata !12, metadata !DIExpression()), !dbg !13
  %db = alloca double, align 8
  call void @llvm.dbg.declare(metadata double* %db, metadata !14, metadata !DIExpression()), !dbg !16
  %fl = alloca float, align 4
  call void @llvm.dbg.declare(metadata float* %fl, metadata !17, metadata !DIExpression()), !dbg !19
  %uln = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %uln, metadata !20, metadata !DIExpression()), !dbg !22
  %uint = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %uint, metadata !23, metadata !DIExpression()), !dbg !25
  %uch = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %uch, metadata !26, metadata !DIExpression()), !dbg !28
  %ln = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %ln, metadata !29, metadata !DIExpression()), !dbg !31
  %in = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %in, metadata !32, metadata !DIExpression()), !dbg !33
  %sh = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %sh, metadata !34, metadata !DIExpression()), !dbg !36
  %ch = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %ch, metadata !37, metadata !DIExpression()), !dbg !39
  %err = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %err, metadata !40, metadata !DIExpression()), !dbg !41
  store i32 0, i32* %err, align 4, !dbg !41
  store i8 65, i8* %ch, align 1, !dbg !39
  store i16 -1024, i16* %sh, align 2, !dbg !36
  store i32 %const28, i32* %in, align 4, !dbg !33
  store i64 %const30, i64* %ln, align 4, !dbg !31
  store i8 -6, i8* %uch, align 1, !dbg !28
  store i32 %const, i32* %uint, align 4, !dbg !25
  store i64 %const29, i64* %uln, align 4, !dbg !22
  store float 0x400921FB40000000, float* %fl, align 4, !dbg !19
  store double 0x400921FB54442D11, double* %db, align 8, !dbg !16
  store i1 true, i1* %bt, align 1, !dbg !13
  store i1 false, i1* %bf, align 1, !dbg !11
  %0 = load i8, i8* %ch, align 1, !dbg !42
...
if.end:                                           ; preds = %entry, %then
  %4 = load i16, i16* %sh, align 2, !dbg !44
...
then19:                                           ; preds = %if.end18
  ...
  %27 = load i32, i32* %err, align 4, !dbg !57
  br label %if.end21, !dbg !57

if.end21:                                         ; preds = %if.end18, %then19
  %28 = load i1, i1* %bf, align 1, !dbg !58
...
then22:                                           ; preds = %if.end21
  ...
  %31 = load i32, i32* %err, align 4, !dbg !59
  br label %if.end24, !dbg !59

if.end24:                                         ; preds = %if.end21, %then22
  %32 = load i32, i32* %err, align 4, !dbg !60
  %33 = icmp eq i32 %32, 0, !dbg !60
  %. = select i1 %33, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @1, i32 0, i32 0), !dbg !61
  %34 = call i32 (i8*, ...) @printf(i8* %.), !dbg !61
  %35 = load i32, i32* %err, align 4, !dbg !62
  ret i32 %35, !dbg !62
}
