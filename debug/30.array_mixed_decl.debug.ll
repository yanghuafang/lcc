...
entry:
  ...
  %5 = bitcast ptr %a to ptr, !dbg !20
  %6 = load i32, ptr %5, align 4, !dbg !20
  %7 = icmp ne i32 %6, 10, !dbg !20
  br i1 %7, label %then, label %if.end, !dbg !20
...
if.end:                                           ; preds = %entry, %then
  ...
  br i1 %11, label %then1, label %if.end3, !dbg !22
...
if.end3:                                          ; preds = %if.end, %then1
  ...
  br i1 %14, label %then4, label %if.end6, !dbg !24
...
if.end6:                                          ; preds = %if.end3, %then4
  ...
  %. = select i1 %17, ptr @0, ptr @1, !dbg !27
  %18 = call i32 (ptr, ...) @printf(ptr %.), !dbg !27
  %19 = load i32, ptr %err, align 4, !dbg !28
  ret i32 %19, !dbg !28
}
