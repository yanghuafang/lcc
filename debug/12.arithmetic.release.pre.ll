...
if.end9:                                          ; preds = %else8, %then7
  ...
  br i1 %57, label %then10, label %else11
...
if.end12:                                         ; preds = %else11, %then10
  %59 = load i32, ptr %div, align 4
  %60 = icmp ne i32 %59, 4
  br i1 %60, label %then13, label %else14
...
if.end18:                                         ; preds = %else17, %then16
  %65 = load i32, ptr %sumeq, align 4
  %66 = icmp ne i32 %65, 53
  br i1 %66, label %then19, label %else20
...
if.end21:                                         ; preds = %else20, %then19
  %68 = load i32, ptr %subeq, align 4
  %69 = icmp ne i32 %68, 45
  br i1 %69, label %then22, label %else23
...
if.end30:                                         ; preds = %else29, %then28
  %77 = load i32, ptr %modeq, align 4
  %78 = icmp ne i32 %77, 5
  br i1 %78, label %then31, label %else32
...
if.end33:                                         ; preds = %else32, %then31
  ...
  %80 = load i32, ptr %ua, align 4
  %81 = load i32, ptr %ub, align 4
  %82 = udiv i32 %80, %81
  %83 = icmp ne i32 %82, 3
  br i1 %83, label %then34, label %else35
...
if.end36:                                         ; preds = %else35, %then34
  %85 = load i32, ptr %ua, align 4
  %86 = load i32, ptr %ub, align 4
  %87 = urem i32 %85, %86
  %88 = icmp ne i32 %87, 1
...
if.end39:                                         ; preds = %else38, %then37
  ...
  %90 = load i32, ptr %negA, align 4
  %91 = load i32, ptr %negB, align 4
  %92 = srem i32 %90, %91
  %93 = icmp ne i32 %92, -2
...
if.end42:                                         ; preds = %else41, %then40
  ...
  %95 = load i32, ptr %mixedSi, align 4
  %96 = load i32, ptr %mixedUi, align 4
  %97 = add i32 %95, %96
  %98 = icmp ne i32 %97, 0
  br i1 %98, label %then43, label %else44
...
then46:                                           ; preds = %if.end45
  %102 = call i32 (ptr, ...) @printf(ptr @0)
  br label %if.end48

else47:                                           ; preds = %if.end45
  %103 = call i32 (ptr, ...) @printf(ptr @1)
  br label %if.end48
