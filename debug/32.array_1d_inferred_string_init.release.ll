...
entry:
  %0 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @ga, i64 0, i64 0), align 16
  %.not = icmp ne i32 %0, 10
  %1 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @ga, i64 0, i64 1), align 4
  %.not98 = icmp ne i32 %1, 7
  %2 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @ga, i64 0, i64 2), align 8
  %.not99 = icmp ne i32 %2, 8
  %3 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @ga, i64 0, i64 3), align 4
  %.not100 = icmp ne i32 %3, 9
  %4 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @ga, i64 0, i64 4), align 16
  %.not101 = icmp ne i32 %4, 1
  %5 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @ga, i64 0, i64 5), align 4
  %.not102 = icmp ne i32 %5, 5
  %6 = load i8, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @gs, i64 0, i64 0), align 1
  %.not103 = icmp ne i8 %6, 104
  %7 = load i8, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @gs, i64 0, i64 1), align 1
  %.not104 = icmp ne i8 %7, 105
  %8 = load i8, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @gs, i64 0, i64 2), align 1
  %.not105 = icmp ne i8 %8, 0
  %9 = load i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @gt, i64 0, i64 0), align 1
  %.not106 = icmp ne i8 %9, 104
  %10 = load i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @gt, i64 0, i64 1), align 1
  %.not107 = icmp ne i8 %10, 101
  %11 = load i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @gt, i64 0, i64 2), align 1
  %.not108 = icmp ne i8 %11, 121
  %12 = load i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @gt, i64 0, i64 3), align 1
  ...
  %. = select i1 %narrow116, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @str, i64 0, i64 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @str.1, i64 0, i64 0)
