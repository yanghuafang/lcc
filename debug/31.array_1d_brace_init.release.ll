...
if.end42:                                         ; preds = %if.end39, %then40
  %72 = load i32, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @gc, i32 0, i32 0), align 4
  %73 = icmp ne i32 %72, 0
  br i1 %73, label %then43, label %if.end45
...
if.end45:                                         ; preds = %if.end42, %then43
  %75 = load i32, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @gc, i32 0, i32 1), align 4
  %76 = icmp ne i32 %75, 0
  br i1 %76, label %then46, label %if.end48
...
if.end48:                                         ; preds = %if.end45, %then46
  %78 = load i32, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @gc, i32 0, i32 2), align 4
  %79 = icmp ne i32 %78, 0
  br i1 %79, label %then49, label %if.end51
...
if.end51:                                         ; preds = %if.end48, %then49
  ...
  %82 = icmp eq i32 %81, 0
  %. = select i1 %82, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @1, i32 0, i32 0)
  %83 = call i32 (i8*, ...) @printf(i8* %.)
