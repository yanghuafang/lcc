...
if.end87:                                         ; preds = %if.end84, %then85
  ...
  %. = select i1 %255, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @1, i32 0, i32 0)
  %256 = call i32 (i8*, ...) @printf(i8* %.)
