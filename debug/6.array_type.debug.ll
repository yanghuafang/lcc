...
entry:
  ...
  %16 = bitcast ptr %i to ptr, !dbg !33
  ...
  %22 = bitcast ptr %i to ptr, !dbg !37
  %23 = load i32, ptr %22, align 4, !dbg !37
  %24 = icmp ne i32 %23, 128, !dbg !37
  br i1 %24, label %then, label %if.end, !dbg !37
...
if.end:                                           ; preds = %entry, %then
  ...
  br i1 %28, label %then1, label %if.end3, !dbg !39
...
if.end3:                                          ; preds = %if.end, %then1
  ...
  br i1 %31, label %then4, label %if.end6, !dbg !41
...
if.end6:                                          ; preds = %if.end3, %then4
  ...
  br i1 %34, label %then7, label %if.end9, !dbg !43
...
if.end12:                                         ; preds = %if.end9, %then10
  ...
  br i1 %43, label %then13, label %if.end15, !dbg !47
...
if.end15:                                         ; preds = %if.end12, %then13
  ...
  br i1 %51, label %then16, label %if.end18, !dbg !51
...
if.end18:                                         ; preds = %if.end15, %then16
  ...
  br i1 %55, label %then19, label %if.end21, !dbg !53
...
if.end21:                                         ; preds = %if.end18, %then19
  ...
  %. = select i1 %58, ptr @1, ptr @2, !dbg !56
  %59 = call i32 (ptr, ...) @printf(ptr %.), !dbg !56
  %60 = load i32, ptr %err, align 4, !dbg !57
  ret i32 %60, !dbg !57
}
