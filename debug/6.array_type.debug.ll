...
entry:
  ...
  %16 = bitcast ptr %i to ptr, !dbg !31
  ...
  %22 = bitcast ptr %i to ptr, !dbg !35
  %23 = load i32, ptr %22, align 4, !dbg !35
  %24 = icmp ne i32 %23, 128, !dbg !35
  br i1 %24, label %then, label %if.end, !dbg !35
...
if.end:                                           ; preds = %entry, %then
  ...
  br i1 %28, label %then1, label %if.end3, !dbg !37
...
if.end3:                                          ; preds = %if.end, %then1
  ...
  br i1 %31, label %then4, label %if.end6, !dbg !39
...
if.end6:                                          ; preds = %if.end3, %then4
  ...
  br i1 %34, label %then7, label %if.end9, !dbg !41
...
if.end12:                                         ; preds = %if.end9, %then10
  ...
  br i1 %43, label %then13, label %if.end15, !dbg !45
...
if.end15:                                         ; preds = %if.end12, %then13
  ...
  br i1 %51, label %then16, label %if.end18, !dbg !49
...
if.end18:                                         ; preds = %if.end15, %then16
  ...
  br i1 %55, label %then19, label %if.end21, !dbg !51
...
if.end21:                                         ; preds = %if.end18, %then19
  ...
  %. = select i1 %58, ptr @1, ptr @2, !dbg !54
  %59 = call i32 (ptr, ...) @printf(ptr %.), !dbg !54
  %60 = load i32, ptr %err, align 4, !dbg !55
  ret i32 %60, !dbg !55
}
...
!6 = !{}
!7 = !DILocalVariable(name: "i", scope: !2, file: !1, line: 13, type: !8)
...
!12 = !DILocalVariable(name: "s", scope: !2, file: !1, line: 12, type: !13)
...
!18 = !DILocalVariable(name: "err", scope: !2, file: !1, line: 11, type: !5)
...
!31 = !DILocation(line: 28, column: 3, scope: !2)
!32 = !DILocation(line: 29, column: 3, scope: !2)
!33 = !DILocation(line: 30, column: 3, scope: !2)
!34 = !DILocation(line: 31, column: 3, scope: !2)
!35 = !DILocation(line: 33, column: 3, scope: !2)
!36 = !DILocation(line: 33, column: 20, scope: !2)
!37 = !DILocation(line: 34, column: 3, scope: !2)
!38 = !DILocation(line: 34, column: 20, scope: !2)
!39 = !DILocation(line: 35, column: 3, scope: !2)
!40 = !DILocation(line: 35, column: 22, scope: !2)
!41 = !DILocation(line: 36, column: 3, scope: !2)
!42 = !DILocation(line: 36, column: 22, scope: !2)
!43 = !DILocation(line: 37, column: 3, scope: !2)
!44 = !DILocation(line: 37, column: 20, scope: !2)
!45 = !DILocation(line: 38, column: 3, scope: !2)
!46 = !DILocation(line: 38, column: 21, scope: !2)
!47 = !DILocation(line: 40, column: 3, scope: !2)
!48 = !DILocation(line: 41, column: 3, scope: !2)
!49 = !DILocation(line: 42, column: 3, scope: !2)
!50 = !DILocation(line: 42, column: 18, scope: !2)
!51 = !DILocation(line: 43, column: 3, scope: !2)
!52 = !DILocation(line: 43, column: 19, scope: !2)
!53 = !DILocation(line: 45, column: 3, scope: !2)
!54 = !DILocation(line: 0, scope: !2)
!55 = !DILocation(line: 50, column: 3, scope: !2)
