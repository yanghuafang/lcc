...
if.end87:                                         ; preds = %else86, %then85
  ...
  br i1 %231, label %then88, label %else89, !dbg !119

then88:                                           ; preds = %if.end87
  %232 = call i32 (ptr, ...) @printf(ptr @0), !dbg !120
  br label %if.end90, !dbg !120

else89:                                           ; preds = %if.end87
  %233 = call i32 (ptr, ...) @printf(ptr @1), !dbg !122
  br label %if.end90, !dbg !122

if.end90:                                         ; preds = %else89, %then88
  %234 = load i32, ptr %err, align 4, !dbg !124
  ret i32 %234, !dbg !124
}
...
!119 = !DILocation(line: 85, column: 3, scope: !2)
!120 = !DILocation(line: 86, column: 5, scope: !121)
!121 = distinct !DILexicalBlock(scope: !2, file: !1, line: 85, column: 17)
!122 = !DILocation(line: 88, column: 5, scope: !123)
!123 = distinct !DILexicalBlock(scope: !2, file: !1, line: 87, column: 10)
!124 = !DILocation(line: 90, column: 3, scope: !2)
