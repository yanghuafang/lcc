...
if.end45:                                         ; preds = %else44, %then43
  %66 = load i32, ptr getelementptr (i32, ptr @gc, i32 1), align 4, !dbg !55
  %67 = icmp ne i32 %66, 0, !dbg !55
  br i1 %67, label %then46, label %else47, !dbg !55

then46:                                           ; preds = %if.end45
  store i32 1, ptr %err, align 4, !dbg !56
  %68 = load i32, ptr %err, align 4, !dbg !56
...
if.end48:                                         ; preds = %else47, %then46
  %69 = load i32, ptr getelementptr (i32, ptr @gc, i32 2), align 4, !dbg !57
  %70 = icmp ne i32 %69, 0, !dbg !57
  br i1 %70, label %then49, label %else50, !dbg !57

then49:                                           ; preds = %if.end48
  store i32 1, ptr %err, align 4, !dbg !58
  %71 = load i32, ptr %err, align 4, !dbg !58
...
if.end51:                                         ; preds = %else50, %then49
  %72 = load i32, ptr %err, align 4, !dbg !59
  %73 = icmp eq i32 %72, 0, !dbg !59
  br i1 %73, label %then52, label %else53, !dbg !59

then52:                                           ; preds = %if.end51
  %74 = call i32 (ptr, ...) @printf(ptr @0), !dbg !60
  br label %if.end54, !dbg !60

else53:                                           ; preds = %if.end51
  %75 = call i32 (ptr, ...) @printf(ptr @1), !dbg !62
  br label %if.end54, !dbg !62

if.end54:                                         ; preds = %else53, %then52
  %76 = load i32, ptr %err, align 4, !dbg !64
  ret i32 %76, !dbg !64
}
...
!6 = !DILocalVariable(name: "lc", scope: !2, file: !1, line: 16, type: !7)
...
!11 = !DILocalVariable(name: "lb", scope: !2, file: !1, line: 15, type: !12)
...
!16 = !DILocalVariable(name: "la", scope: !2, file: !1, line: 14, type: !17)
...
!21 = !DILocalVariable(name: "err", scope: !2, file: !1, line: 13, type: !5)
!22 = !DILocation(line: 13, column: 3, scope: !2)
!23 = !DILocation(line: 18, column: 3, scope: !2)
!24 = !DILocation(line: 18, column: 19, scope: !2)
!25 = !DILocation(line: 19, column: 3, scope: !2)
!26 = !DILocation(line: 19, column: 19, scope: !2)
!27 = !DILocation(line: 20, column: 3, scope: !2)
!28 = !DILocation(line: 20, column: 19, scope: !2)
!29 = !DILocation(line: 21, column: 3, scope: !2)
!30 = !DILocation(line: 21, column: 19, scope: !2)
!31 = !DILocation(line: 23, column: 3, scope: !2)
!32 = !DILocation(line: 23, column: 19, scope: !2)
!33 = !DILocation(line: 24, column: 3, scope: !2)
!34 = !DILocation(line: 24, column: 19, scope: !2)
!35 = !DILocation(line: 25, column: 3, scope: !2)
!36 = !DILocation(line: 25, column: 19, scope: !2)
!37 = !DILocation(line: 27, column: 3, scope: !2)
!38 = !DILocation(line: 27, column: 19, scope: !2)
!39 = !DILocation(line: 28, column: 3, scope: !2)
!40 = !DILocation(line: 28, column: 19, scope: !2)
!41 = !DILocation(line: 30, column: 3, scope: !2)
!42 = !DILocation(line: 30, column: 19, scope: !2)
!43 = !DILocation(line: 31, column: 3, scope: !2)
!44 = !DILocation(line: 31, column: 19, scope: !2)
!45 = !DILocation(line: 32, column: 3, scope: !2)
!46 = !DILocation(line: 32, column: 19, scope: !2)
!47 = !DILocation(line: 33, column: 3, scope: !2)
!48 = !DILocation(line: 33, column: 19, scope: !2)
!49 = !DILocation(line: 35, column: 3, scope: !2)
!50 = !DILocation(line: 35, column: 20, scope: !2)
!51 = !DILocation(line: 36, column: 3, scope: !2)
!52 = !DILocation(line: 36, column: 20, scope: !2)
!53 = !DILocation(line: 38, column: 3, scope: !2)
!54 = !DILocation(line: 38, column: 19, scope: !2)
!55 = !DILocation(line: 39, column: 3, scope: !2)
!56 = !DILocation(line: 39, column: 19, scope: !2)
!57 = !DILocation(line: 40, column: 3, scope: !2)
!58 = !DILocation(line: 40, column: 19, scope: !2)
!59 = !DILocation(line: 42, column: 3, scope: !2)
!60 = !DILocation(line: 43, column: 5, scope: !61)
!61 = distinct !DILexicalBlock(scope: !2, file: !1, line: 42, column: 17)
!62 = !DILocation(line: 45, column: 5, scope: !63)
!63 = distinct !DILexicalBlock(scope: !2, file: !1, line: 44, column: 10)
!64 = !DILocation(line: 47, column: 3, scope: !2)
