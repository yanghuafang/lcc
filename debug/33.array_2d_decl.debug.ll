...
entry:
  ...
  %10 = bitcast ptr %9 to ptr, !dbg !30
  ...
  %31 = bitcast ptr %30 to ptr, !dbg !39
  %32 = bitcast ptr %31 to ptr, !dbg !39
  store i32 8, ptr %32, align 4, !dbg !39
  %33 = load i32, ptr %32, align 4, !dbg !39
  %34 = bitcast ptr %m to ptr, !dbg !40
  %35 = bitcast ptr %34 to ptr, !dbg !40
  ...
  br i1 %39, label %then, label %if.end, !dbg !41
...
if.end:                                           ; preds = %entry, %then
  %41 = bitcast ptr %m to ptr, !dbg !43
  ...
  br i1 %46, label %then1, label %if.end3, !dbg !44
...
if.end3:                                          ; preds = %if.end, %then1
  ...
  br i1 %53, label %then4, label %if.end6, !dbg !47
...
if.end6:                                          ; preds = %if.end3, %then4
  ...
  br i1 %60, label %then7, label %if.end9, !dbg !50
...
if.end9:                                          ; preds = %if.end6, %then7
  ...
  br i1 %63, label %then10, label %if.end12, !dbg !52
...
if.end12:                                         ; preds = %if.end9, %then10
  ...
  br i1 %68, label %then13, label %if.end15, !dbg !55
...
if.end15:                                         ; preds = %if.end12, %then13
  ...
  br i1 %73, label %then16, label %if.end18, !dbg !58
...
if.end18:                                         ; preds = %if.end15, %then16
  ...
  br i1 %78, label %then19, label %if.end21, !dbg !61
...
if.end21:                                         ; preds = %if.end18, %then19
  ...
  br i1 %83, label %then22, label %if.end24, !dbg !64
...
if.end24:                                         ; preds = %if.end21, %then22
  %85 = bitcast ptr %grid to ptr, !dbg !66
  %86 = getelementptr %struct.Cell, ptr %85, i32 1, !dbg !66
  %87 = bitcast ptr %86 to ptr, !dbg !66
  ...
  br i1 %91, label %then25, label %if.end27, !dbg !67
...
if.end27:                                         ; preds = %if.end24, %then25
  %93 = bitcast ptr %grid to ptr, !dbg !69
  ...
  br i1 %99, label %then28, label %if.end30, !dbg !70
...
if.end30:                                         ; preds = %if.end27, %then28
  ...
  %102 = bitcast ptr %101 to ptr, !dbg !72
  %103 = bitcast ptr %102 to ptr, !dbg !72
  ...
  br i1 %107, label %then31, label %if.end33, !dbg !73
...
if.end33:                                         ; preds = %if.end30, %then31
  ...
  %. = select i1 %110, ptr @0, ptr @1, !dbg !76
  %111 = call i32 (ptr, ...) @printf(ptr %.), !dbg !76
  %112 = load i32, ptr %err, align 4, !dbg !77
  ret i32 %112, !dbg !77
}
...
!18 = !DILocalVariable(name: "scalar", scope: !4, file: !1, line: 12, type: !7)
!19 = !DILocation(line: 12, column: 3, scope: !4)
!20 = !DILocalVariable(name: "m", scope: !4, file: !1, line: 12, type: !21)
...
!25 = !DILocalVariable(name: "err", scope: !4, file: !1, line: 11, type: !7)
!26 = !DILocation(line: 11, column: 3, scope: !4)
!27 = !DILocation(line: 16, column: 3, scope: !4)
!28 = !DILocation(line: 17, column: 3, scope: !4)
...
!37 = !DILocation(line: 28, column: 3, scope: !4)
!38 = !DILocation(line: 29, column: 3, scope: !4)
!39 = !DILocation(line: 30, column: 3, scope: !4)
!40 = !DILocation(line: 32, column: 3, scope: !4)
!41 = !DILocation(line: 33, column: 3, scope: !4)
!42 = !DILocation(line: 33, column: 15, scope: !4)
!43 = !DILocation(line: 34, column: 3, scope: !4)
!44 = !DILocation(line: 35, column: 3, scope: !4)
!45 = !DILocation(line: 35, column: 15, scope: !4)
!46 = !DILocation(line: 36, column: 3, scope: !4)
!47 = !DILocation(line: 37, column: 3, scope: !4)
!48 = !DILocation(line: 37, column: 15, scope: !4)
!49 = !DILocation(line: 38, column: 3, scope: !4)
!50 = !DILocation(line: 39, column: 3, scope: !4)
!51 = !DILocation(line: 39, column: 15, scope: !4)
!52 = !DILocation(line: 40, column: 3, scope: !4)
!53 = !DILocation(line: 40, column: 21, scope: !4)
!54 = !DILocation(line: 42, column: 3, scope: !4)
!55 = !DILocation(line: 43, column: 3, scope: !4)
!56 = !DILocation(line: 43, column: 16, scope: !4)
!57 = !DILocation(line: 44, column: 3, scope: !4)
!58 = !DILocation(line: 45, column: 3, scope: !4)
!59 = !DILocation(line: 45, column: 16, scope: !4)
!60 = !DILocation(line: 46, column: 3, scope: !4)
!61 = !DILocation(line: 47, column: 3, scope: !4)
!62 = !DILocation(line: 47, column: 16, scope: !4)
!63 = !DILocation(line: 48, column: 3, scope: !4)
!64 = !DILocation(line: 49, column: 3, scope: !4)
!65 = !DILocation(line: 49, column: 15, scope: !4)
!66 = !DILocation(line: 51, column: 3, scope: !4)
!67 = !DILocation(line: 52, column: 3, scope: !4)
!68 = !DILocation(line: 52, column: 15, scope: !4)
!69 = !DILocation(line: 53, column: 3, scope: !4)
!70 = !DILocation(line: 54, column: 3, scope: !4)
!71 = !DILocation(line: 54, column: 16, scope: !4)
!72 = !DILocation(line: 55, column: 3, scope: !4)
!73 = !DILocation(line: 56, column: 3, scope: !4)
!74 = !DILocation(line: 56, column: 15, scope: !4)
!75 = !DILocation(line: 58, column: 3, scope: !4)
!76 = !DILocation(line: 0, scope: !4)
!77 = !DILocation(line: 63, column: 3, scope: !4)
