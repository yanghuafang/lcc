...
if.end:                                           ; preds = %else, %then
  ...
  br i1 %4, label %then1, label %else2, !dbg !39
...
if.end3:                                          ; preds = %else2, %then1
  ...
  br i1 %7, label %then4, label %else5, !dbg !41
...
if.end6:                                          ; preds = %else5, %then4
  ...
  br i1 %10, label %then7, label %else8, !dbg !43
...
if.end9:                                          ; preds = %else8, %then7
  ...
  br i1 %13, label %then10, label %else11, !dbg !45

then10:                                           ; preds = %if.end9
  %14 = call i32 (ptr, ...) @printf(ptr @0), !dbg !46
  br label %if.end12, !dbg !46

else11:                                           ; preds = %if.end9
  %15 = call i32 (ptr, ...) @printf(ptr @1), !dbg !48
...
!17 = distinct !DILexicalBlock(scope: !4, file: !3, line: 9, column: 18)
!18 = !DILocation(line: 11, column: 5, scope: !17)
!19 = !DILocation(line: 13, column: 3, scope: !4)
!20 = distinct !DISubprogram(name: "countSum2", linkageName: "countSum2", scope: null, file: !3, line: 16, type: !5, scopeLine: 16, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !8)
!21 = !DILocalVariable(name: "i", scope: !20, file: !3, line: 18, type: !7)
!22 = !DILocation(line: 18, column: 3, scope: !20)
!23 = !DILocalVariable(name: "sum", scope: !20, file: !3, line: 17, type: !7)
!24 = !DILocation(line: 17, column: 3, scope: !20)
!25 = !DILocalVariable(name: "n", arg: 1, scope: !20, file: !3, line: 16, type: !7)
!26 = !DILocation(line: 16, column: 5, scope: !20)
!27 = !DILocation(line: 19, column: 3, scope: !20)
!28 = !DILocation(line: 20, column: 5, scope: !29)
!29 = distinct !DILexicalBlock(scope: !20, file: !3, line: 19, column: 6)
!30 = !DILocation(line: 21, column: 5, scope: !29)
!31 = !DILocation(line: 23, column: 3, scope: !20)
!32 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 26, type: !33, scopeLine: 26, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !8)
!33 = !DISubroutineType(types: !34)
!34 = !{!7}
!35 = !DILocalVariable(name: "err", scope: !32, file: !3, line: 27, type: !7)
!36 = !DILocation(line: 27, column: 3, scope: !32)
!37 = !DILocation(line: 29, column: 3, scope: !32)
!38 = !DILocation(line: 29, column: 30, scope: !32)
!39 = !DILocation(line: 30, column: 3, scope: !32)
!40 = !DILocation(line: 30, column: 31, scope: !32)
!41 = !DILocation(line: 31, column: 3, scope: !32)
!42 = !DILocation(line: 31, column: 25, scope: !32)
!43 = !DILocation(line: 32, column: 3, scope: !32)
!44 = !DILocation(line: 32, column: 26, scope: !32)
!45 = !DILocation(line: 34, column: 3, scope: !32)
!46 = !DILocation(line: 35, column: 5, scope: !47)
!47 = distinct !DILexicalBlock(scope: !32, file: !3, line: 34, column: 17)
!48 = !DILocation(line: 37, column: 5, scope: !49)
!49 = distinct !DILexicalBlock(scope: !32, file: !3, line: 36, column: 10)
!50 = !DILocation(line: 39, column: 3, scope: !32)
