...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %day, metadata !13, metadata !DIExpression()), !dbg !14
  ...
  store i32 5, i32* %day, align 4, !dbg !14
  store i32 1, i32* %sex, align 4, !dbg !12
  store i32 0, i32* %v, align 4, !dbg !17
  %0 = load i32, i32* %v, align 4, !dbg !17
  %1 = load i32, i32* %v, align 4, !dbg !18
  %2 = icmp ne i32 %1, 0, !dbg !18
  br i1 %2, label %then, label %if.end, !dbg !18

then:                                             ; preds = %entry
  store i32 1, i32* %err, align 4, !dbg !19
  %3 = load i32, i32* %err, align 4, !dbg !19
  br label %if.end, !dbg !19

if.end:                                           ; preds = %entry, %then
  store i32 1, i32* %v, align 4, !dbg !20
  %4 = load i32, i32* %v, align 4, !dbg !20
  %5 = load i32, i32* %v, align 4, !dbg !21
...
if.end3:                                          ; preds = %if.end, %then1
  store i32 5, i32* %v, align 4, !dbg !23
  %8 = load i32, i32* %v, align 4, !dbg !23
  %9 = load i32, i32* %v, align 4, !dbg !24
...
if.end6:                                          ; preds = %if.end3, %then4
  store i32 6, i32* %v, align 4, !dbg !26
  %12 = load i32, i32* %v, align 4, !dbg !26
  %13 = load i32, i32* %v, align 4, !dbg !27
...
if.end9:                                          ; preds = %if.end6, %then7
  %16 = load i32, i32* %day, align 4, !dbg !29
  store i32 %16, i32* %v, align 4, !dbg !29
  %17 = load i32, i32* %v, align 4, !dbg !29
  %18 = load i32, i32* %v, align 4, !dbg !30
  %19 = icmp ne i32 %18, 5, !dbg !30
  br i1 %19, label %then10, label %if.end12, !dbg !30

then10:                                           ; preds = %if.end9
  store i32 1, i32* %err, align 4, !dbg !31
  %20 = load i32, i32* %err, align 4, !dbg !31
  br label %if.end12, !dbg !31

if.end12:                                         ; preds = %if.end9, %then10
  store i32 0, i32* %v, align 4, !dbg !32
  %21 = load i32, i32* %v, align 4, !dbg !32
  %22 = load i32, i32* %v, align 4, !dbg !33
  %23 = icmp ne i32 %22, 0, !dbg !33
  br i1 %23, label %then13, label %if.end15, !dbg !33

then13:                                           ; preds = %if.end12
  store i32 1, i32* %err, align 4, !dbg !34
  %24 = load i32, i32* %err, align 4, !dbg !34
  br label %if.end15, !dbg !34

if.end15:                                         ; preds = %if.end12, %then13
  store i32 1, i32* %v, align 4, !dbg !35
  %25 = load i32, i32* %v, align 4, !dbg !35
  %26 = load i32, i32* %v, align 4, !dbg !36
  %27 = icmp ne i32 %26, 1, !dbg !36
  br i1 %27, label %then16, label %if.end18, !dbg !36

then16:                                           ; preds = %if.end15
  store i32 1, i32* %err, align 4, !dbg !37
  %28 = load i32, i32* %err, align 4, !dbg !37
  br label %if.end18, !dbg !37

if.end18:                                         ; preds = %if.end15, %then16
  %29 = load i32, i32* %sex, align 4, !dbg !38
  store i32 %29, i32* %v, align 4, !dbg !38
  %30 = load i32, i32* %v, align 4, !dbg !38
  %31 = load i32, i32* %v, align 4, !dbg !39
  %32 = icmp ne i32 %31, 1, !dbg !39
  br i1 %32, label %then19, label %if.end21, !dbg !39

then19:                                           ; preds = %if.end18
  store i32 1, i32* %err, align 4, !dbg !40
  %33 = load i32, i32* %err, align 4, !dbg !40
  br label %if.end21, !dbg !40

if.end21:                                         ; preds = %if.end18, %then19
  %34 = load i32, i32* %err, align 4, !dbg !41
  %35 = icmp eq i32 %34, 0, !dbg !41
  %. = select i1 %35, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @1, i32 0, i32 0), !dbg !42
  %36 = call i32 (i8*, ...) @printf(i8* %.), !dbg !42
  %37 = load i32, i32* %err, align 4, !dbg !43
  ret i32 %37, !dbg !43
}
