...
if.end3:                                          ; preds = %else2, %then1
  ...
  br i1 %10, label %then4, label %else5, !dbg !24
...
if.end6:                                          ; preds = %else5, %then4
  ...
  br i1 %14, label %then7, label %else8, !dbg !27
...
if.end9:                                          ; preds = %else8, %then7
  ...
  br i1 %19, label %then10, label %else11, !dbg !30
...
if.end12:                                         ; preds = %else11, %then10
  ...
  br i1 %23, label %then13, label %else14, !dbg !33
...
if.end15:                                         ; preds = %else14, %then13
  ...
  br i1 %27, label %then16, label %else17, !dbg !36
...
if.end18:                                         ; preds = %else17, %then16
  ...
  br i1 %32, label %then19, label %else20, !dbg !39
...
if.end21:                                         ; preds = %else20, %then19
  ...
  br i1 %35, label %then22, label %else23, !dbg !41

then22:                                           ; preds = %if.end21
  %36 = call i32 (ptr, ...) @printf(ptr @0), !dbg !42
  br label %if.end24, !dbg !42

else23:                                           ; preds = %if.end21
  %37 = call i32 (ptr, ...) @printf(ptr @1), !dbg !44
  br label %if.end24, !dbg !44

if.end24:                                         ; preds = %else23, %then22
  %38 = load i32, ptr %err, align 4, !dbg !46
  ret i32 %38, !dbg !46
}
...
!19 = !DILocation(line: 25, column: 15, scope: !4)
!20 = !DILocation(line: 26, column: 3, scope: !4)
!21 = !DILocation(line: 27, column: 3, scope: !4)
!22 = !DILocation(line: 27, column: 15, scope: !4)
!23 = !DILocation(line: 28, column: 3, scope: !4)
!24 = !DILocation(line: 29, column: 3, scope: !4)
!25 = !DILocation(line: 29, column: 15, scope: !4)
!26 = !DILocation(line: 30, column: 3, scope: !4)
!27 = !DILocation(line: 31, column: 3, scope: !4)
!28 = !DILocation(line: 31, column: 15, scope: !4)
!29 = !DILocation(line: 32, column: 3, scope: !4)
!30 = !DILocation(line: 33, column: 3, scope: !4)
!31 = !DILocation(line: 33, column: 15, scope: !4)
!32 = !DILocation(line: 34, column: 3, scope: !4)
!33 = !DILocation(line: 35, column: 3, scope: !4)
!34 = !DILocation(line: 35, column: 15, scope: !4)
!35 = !DILocation(line: 36, column: 3, scope: !4)
!36 = !DILocation(line: 37, column: 3, scope: !4)
!37 = !DILocation(line: 37, column: 15, scope: !4)
!38 = !DILocation(line: 38, column: 3, scope: !4)
!39 = !DILocation(line: 39, column: 3, scope: !4)
