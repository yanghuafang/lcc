...
entry:
  ...
  %5 = select i1 %2, i32 %3, i32 %4, !dbg !23
  ...
  %11 = select i1 %8, i32 %9, i32 %10, !dbg !21
...
if.end:                                           ; preds = %else, %then
  ...
  br i1 %16, label %then1, label %else2, !dbg !32
...
if.end3:                                          ; preds = %else2, %then1
  ...
  %23 = select i1 %20, i32 %21, i32 %22, !dbg !15
...
if.end6:                                          ; preds = %else5, %then4
  ...
  br i1 %34, label %then7, label %else8, !dbg !36
...
if.end12:                                         ; preds = %else11, %then10
  ...
  br i1 %44, label %then13, label %else14, !dbg !40
