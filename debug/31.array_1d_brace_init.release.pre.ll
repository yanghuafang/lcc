...
if.end45:                                         ; preds = %else44, %then43
  %66 = load i32, ptr getelementptr (i32, ptr @gc, i32 1), align 4
  %67 = icmp ne i32 %66, 0
  br i1 %67, label %then46, label %else47
...
if.end48:                                         ; preds = %else47, %then46
  %69 = load i32, ptr getelementptr (i32, ptr @gc, i32 2), align 4
  %70 = icmp ne i32 %69, 0
...
if.end51:                                         ; preds = %else50, %then49
  ...
  %73 = icmp eq i32 %72, 0
  br i1 %73, label %then52, label %else53

then52:                                           ; preds = %if.end51
  %74 = call i32 (ptr, ...) @printf(ptr @0)
  br label %if.end54

else53:                                           ; preds = %if.end51
  %75 = call i32 (ptr, ...) @printf(ptr @1)
  br label %if.end54
